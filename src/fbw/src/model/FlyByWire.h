...
struct Parameters_FlyByWire_T_ {
  ...
  real_T DiscreteDerivativeVariableTs_Gain_a;
  ...
  real_T DiscreteTimeIntegratorVariableTs_LowerLimit_kc;
  ...
  real_T DiscreteTimeIntegratorVariableTs_UpperLimit_a;
  ...
  real_T RateLimiterVariableTs_lo_fe;
  ...
  real_T RateLimiterVariableTs_up_e;
  ...
  real_T Constant_Value_jp;
  real_T Delay1_InitialCondition_g4;
  real_T Gain4_Gain_o;
  real_T Gain7_Gain;
  real_T Saturation_UpperSat_i;
  real_T Saturation_LowerSat_ps;
  real_T Constant_Value_ny;
