...
struct Parameters_FlyByWire_T_ {
  ...
  real_T Saturation_LowerSat_ao;
  real_T Constant_Value_p;
  real_T Saturation_UpperSat_c;
  real_T Saturation_LowerSat_ci;
  ...
  real_T Saturation_UpperSat_ep;
  real_T Saturation_LowerSat_n;
  real_T Constant_Value_gk;
  real_T Delay_InitialCondition_ej;
  real_T Constant_Value_e;
  real_T Delay1_InitialCondition_mq;
  ...
  real_T Saturation_UpperSat_erp;
  real_T Saturation_LowerSat_lj;
