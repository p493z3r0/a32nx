...
struct Parameters_FlyByWire_T_ {
  ...
  real_T uDLookupTable_bp01Data_j[4];
  ...
  real_T Saturation_LowerSat_er;
  real_T Constant_Value_hk;
  real_T Saturation_UpperSat_db;
  real_T Saturation_LowerSat_pri;
  ...
  real_T Delay1_InitialCondition_hh;
  real_T Gain1_Gain_m;
