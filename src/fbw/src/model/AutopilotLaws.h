...
typedef struct {
  ...
  rtDW_Chart_AutopilotLaws_d_T sf_Chart_d;
  rtDW_Chart_AutopilotLaws_T sf_Chart_ci;
  rtDW_Chart_AutopilotLaws_T sf_Chart_gq;
...
struct Parameters_AutopilotLaws_T_ {
  ...
  real_T ScheduledGain_BreakpointsForDimension1_hj[4];
  ...
  real_T Constant3_Value_b2;
  real_T Constant3_Value_ea;
  real_T Gain3_Gain;
  real_T Gain_Gain_ba;
  real_T Constant_Value_e;
  real_T Constant3_Value_j;
  real_T Constant3_Value_fn;
  real_T Gain3_Gain_i;
  ...
  real_T Gain1_Gain_j;
  real_T Gain3_Gain_o;
  real_T Delay_InitialCondition_fe;
  ...
  real_T Delay1_InitialCondition_gw;
  real_T Bias_Bias;
...
class AutopilotLawsModelClass {
 ...
 private:
  ...
  void AutopilotLaws_Chart_n_Init(rtDW_Chart_AutopilotLaws_d_T *localDW);
  void AutopilotLaws_Chart_p(real_T rtu_right, real_T rtu_left, boolean_T rtu_use_short_path, real_T *rty_out,
