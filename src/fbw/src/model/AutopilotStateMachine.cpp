...
void AutopilotStateMachineModelClass::AutopilotStateMachine_ALT(void)
{
  ...
  if (AutopilotStateMachine_B.BusAssignment_g.vertical.armed.GS &&
    ...
    if (AutopilotStateMachine_B.BusAssignment_g.input.ALT_pull && (tmp < -50.0)) {
      AutopilotStateMachine_DWork.is_ON = AutopilotStateMachine_IN_OP_DES;
      AutopilotStateMachine_OP_DES_entry();
    } else if (AutopilotStateMachine_B.BusAssignment_g.input.ALT_pull && (tmp > 50.0)) {
      ...
      if (AutopilotStateMachine_B.BusAssignment_g.input.ALT_push &&
        ...
        AutopilotStateMachine_ALT_entry();
                  ...
                  (AutopilotStateMachine_B.BusAssignment_g.input.H_fcu_ft <
                   AutopilotStateMachine_B.BusAssignment_g.data.H_ind_ft)) ||
                 ((AutopilotStateMachine_DWork.local_H_fcu_ft < AutopilotStateMachine_B.BusAssignment_g.data.H_ind_ft) &&
                  (AutopilotStateMachine_B.BusAssignment_g.input.H_fcu_ft >
...
void AutopilotStateMachineModelClass::AutopilotStateMachine_ALT_CST_CPT(void)
{
  ...
  if (AutopilotStateMachine_B.BusAssignment_g.vertical.condition.ALT_CST) {
    ...
    guard5 = false;
    guard6 = false;
    if (AutopilotStateMachine_B.BusAssignment_g.input.ALT_pull && (tmp_0 < -50.0)) {
      guard1 = true;
    } else if (AutopilotStateMachine_B.BusAssignment_g.input.ALT_pull && (tmp_0 > 50.0)) {
      guard2 = true;
    } else {
      tmp = std::abs(AutopilotStateMachine_B.BusAssignment_g.input.H_constraint_ft -
                     AutopilotStateMachine_B.BusAssignment_g.data.H_ind_ft);
...
void AutopilotStateMachineModelClass::step()
{
  ...
  AutopilotStateMachine_B.BusAssignment_g.vertical.armed.ALT_CST =
    ((((AutopilotStateMachine_U.in.data.acceleration_altitude == 0.0) && (AutopilotStateMachine_U.in.data.flight_phase >
        5.0)) || ((AutopilotStateMachine_U.in.data.acceleration_altitude > 0.0) &&
                  (AutopilotStateMachine_U.in.data.H_ind_ft > AutopilotStateMachine_U.in.data.acceleration_altitude))) &&
     (AutopilotStateMachine_U.in.data.flight_phase <= 7.0) && (AutopilotStateMachine_DWork.newFcuAltitudeSelected != 0.0)
     && rtb_Y && (((rtb_Divide > 50.0) && (AutopilotStateMachine_U.in.input.H_constraint_ft <
        AutopilotStateMachine_U.in.input.H_fcu_ft)) || ((rtb_Divide < -50.0) &&
       (AutopilotStateMachine_U.in.input.H_constraint_ft > AutopilotStateMachine_U.in.input.H_fcu_ft))) &&
     ((AutopilotStateMachine_DWork.Delay1_DSTATE.output.mode == vertical_mode_CLB) ||
      (AutopilotStateMachine_DWork.Delay1_DSTATE.output.mode == vertical_mode_DES)));
  if (AutopilotStateMachine_DWork.Delay1_DSTATE.output.mode == vertical_mode_ALT_CPT) {
  ...
  if (AutopilotStateMachine_U.in.data.H_dot_ft_min < 0.0) {
    ...
    rtb_Saturation = AutopilotStateMachine_U.in.data.H_dot_ft_min;
  }
  ...
  rtb_GainTheta1 = std::abs(AutopilotStateMachine_U.in.data.H_dot_ft_min) / 6.0;
  AutopilotStateMachine_B.BusAssignment_g.vertical.condition.ALT_CPT = ((sCLB_tmp <= rtb_GainTheta1) && ((rtb_GainTheta ==
    rtb_Saturation) && state_tmp));
  rtb_GainTheta = AutopilotStateMachine_U.in.input.H_constraint_ft - AutopilotStateMachine_U.in.data.H_ind_ft;
  sCLB_tmp = std::abs(rtb_GainTheta);
  ...
  AutopilotStateMachine_B.BusAssignment_g.vertical.condition.ALT_CST_CPT =
    ((AutopilotStateMachine_U.in.input.H_constraint_ft != 0.0) && (AutopilotStateMachine_U.in.input.H_constraint_ft !=
      AutopilotStateMachine_U.in.input.H_fcu_ft) && ((sCLB_tmp <= rtb_GainTheta1) && ((rtb_GainTheta == rtb_Saturation) &&
       state_tmp)));
  ...
  if (AutopilotStateMachine_DWork.is_active_c6_AutopilotStateMachine == 0U) {
    ...
    if (AutopilotStateMachine_B.BusAssignment_g.data.ap_fd_active &&
      ...
      AutopilotStateMachine_DWork.is_ON = AutopilotStateMachine_IN_SRS;
      AutopilotStateMachine_SRS_entry();
    } else if (AutopilotStateMachine_B.BusAssignment_g.input.VS_pull ||
               ((AutopilotStateMachine_B.BusAssignment_g.data.flight_phase >= 6.0) &&
                (AutopilotStateMachine_B.BusAssignment_g.data.on_ground == 0.0) &&
  ...
  if (rtb_GainTheta1 < 1.0) {
    ...
    rtb_BusAssignment_input_LOC_push = AutopilotStateMachine_DWork.Delay_DSTATE_b[100U - rtb_Divide_0];
  }
  ...
  for (rtb_on_ground = 0; rtb_on_ground < 99; rtb_on_ground++) {
    ...
    AutopilotStateMachine_DWork.Delay_DSTATE_c[rtb_on_ground] = AutopilotStateMachine_DWork.Delay_DSTATE_c[rtb_on_ground
      + 1];
    AutopilotStateMachine_DWork.Delay_DSTATE_b[rtb_on_ground] = AutopilotStateMachine_DWork.Delay_DSTATE_b[rtb_on_ground
      + 1];
  }
  ...
  AutopilotStateMachine_DWork.Delay_DSTATE_b[99] = rtb_OR;
}
...
void AutopilotStateMachineModelClass::initialize()
{
...

  {
    ...
    for (i = 0; i < 100; i++) {
      ...
      AutopilotStateMachine_DWork.Delay_DSTATE_b[i] = AutopilotStateMachine_P.Delay_InitialCondition_d;
    }
