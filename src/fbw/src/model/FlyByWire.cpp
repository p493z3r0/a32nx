...
void FlyByWireModelClass::step()
{
  ...
  rtb_Gain1_o = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_f;
  ...
  FlyByWire_DWork.Delay_DSTATE_f += u1;
  if (FlyByWire_DWork.is_active_c6_FlyByWire == 0U) {
    ...
    if ((FlyByWire_DWork.Delay_DSTATE_f == 0.0) && (FlyByWire_U.in.data.V_tas_kn > 100.0) &&
    ...
    if ((FlyByWire_DWork.Delay_DSTATE_f == 1.0) || (FlyByWire_U.in.data.H_radio_ft > 400.0) ||
  ...
  FlyByWire_DWork.Delay1_DSTATE = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_d - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE + (rtb_GainTheta + FlyByWire_DWork.Delay_DSTATE_o) * (rtb_Limiterxi / rtb_Limiterxi1);
  ...
  rtb_Gain1_o = rtb_ManualSwitch - FlyByWire_DWork.Delay_DSTATE_n;
  ...
  rtb_Gain1_o = FlyByWire_B.flare_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_d;
  ...
  rtb_Gain1_o = FlyByWire_U.in.data.autopilot_custom_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_du;
  ...
  FlyByWire_DWork.Delay_DSTATE_du += u1;
  rtb_Gain1_o = Theta - FlyByWire_DWork.Delay_DSTATE_l;
  ...
  FlyByWire_DWork.Delay_DSTATE_l += u1;
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold_k) {
    rtb_Sum5 = (FlyByWire_DWork.Delay_DSTATE_du - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    ...
    if (FlyByWire_DWork.Delay_DSTATE_l <= rtb_Saturation2) {
      ...
      if (FlyByWire_DWork.Delay_DSTATE_l >= rtb_Saturation2) {
        rtb_Saturation2 = FlyByWire_DWork.Delay_DSTATE_l;
      }
    }
  ...
  rtb_Limitereta = FlyByWire_P.Gain1_Gain_j * result[1] * (FlyByWire_P.Gain_Gain_dc * FlyByWire_P.Vm_currentms_Value) +
  ...
  rtb_Limiterxi = rtb_Limitereta - (look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.uDLookupTable_bp01Data,
    FlyByWire_P.uDLookupTable_tableData, 3U) / (FlyByWire_P.Gain5_Gain * rtb_Limiterxi) + FlyByWire_P.Bias_Bias) *
    rtb_Gain1_o;
  ...
  rtb_Gain1_o = ((rtb_Switch_c - FlyByWire_DWork.Delay_DSTATE_c) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_l +
                 rtb_Limiterxi * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.PLUT_bp01Data,
    FlyByWire_P.PLUT_tableData, 1U)) + (rtb_Saturation2 - FlyByWire_DWork.Delay_DSTATE_k) / FlyByWire_U.in.time.dt;
  ...
  u1 = Theta - FlyByWire_DWork.Delay_DSTATE_j;
  ...
  rtb_Limitereta = look1_binlxpw(FlyByWire_DWork.Delay_DSTATE_j, FlyByWire_P.PitchRateDemand_bp01Data,
    FlyByWire_P.PitchRateDemand_tableData, 2U);
  FlyByWire_Y.out.pitch.law_rotation.qk_c_deg_s = rtb_Limitereta;
  rtb_Gain_l = FlyByWire_P.DiscreteDerivativeVariableTs_Gain_c * rtb_Limitereta;
  rtb_Sum5 = result[1] - rtb_Limitereta;
  rtb_Gain_pj = FlyByWire_P.Gain_Gain_h * rtb_Sum5;
  rtb_Gain_m = FlyByWire_P.Gain1_Gain_i * rtb_Sum5 * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_b;
  rtb_Sum2 = FlyByWire_P.Gain5_Gain_m * result_0[1] + result[1];
  rtb_Sum5 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_i;
  rtb_Limiterxi = rtb_Sum5 + FlyByWire_P.Constant_Value_h;
  FlyByWire_DWork.Delay1_DSTATE_k = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_h - rtb_Sum5) *
    FlyByWire_DWork.Delay1_DSTATE_k + (rtb_Sum2 + FlyByWire_DWork.Delay_DSTATE_a) * (rtb_Sum5 / rtb_Limiterxi);
  rtb_Limitereta = (((((rtb_Gain_m - FlyByWire_DWork.Delay_DSTATE_m) / FlyByWire_U.in.time.dt + rtb_Gain_pj) *
                      FlyByWire_P.Gain1_Gain_a + (rtb_Gain_l - FlyByWire_DWork.Delay_DSTATE_p) / FlyByWire_U.in.time.dt *
                      FlyByWire_P.Gain3_Gain_p) + (FlyByWire_DWork.Delay1_DSTATE_k - rtb_Limitereta) *
  ...
  if (FlyByWire_DWork.icLoad != 0) {
    FlyByWire_DWork.Delay_DSTATE_e = rtb_Gainpk4 - rtb_Limitereta;
  }
  ...
  if (rtb_Limitereta > FlyByWire_P.DiscreteTimeIntegratorVariableTs_UpperLimit) {
    ...
    FlyByWire_DWork.Delay_DSTATE_e = rtb_Limitereta;
  }

  rtb_Limitereta = FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_k * rtb_Gain1_o * FlyByWire_U.in.time.dt;
  if ((FlyByWire_DWork.Delay_DSTATE_f == 0.0) || (rtb_BusAssignment_a_sim_data_computed_tracking_mode_on != 0)) {
  ...
  if (FlyByWire_DWork.icLoad_e != 0) {
    ...
    FlyByWire_DWork.Delay_DSTATE_f1 = rtb_Limiterxi - rtb_Limitereta;
  }
  ...
  if (FlyByWire_DWork.Delay_DSTATE_f > FlyByWire_P.Saturation_UpperSat_i) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_i;
  } else if (FlyByWire_DWork.Delay_DSTATE_f < FlyByWire_P.Saturation_LowerSat_h) {
  ...
  rtb_Gain_pj = FlyByWire_P.Constant_Value_c - rtb_Limitereta;
  if (FlyByWire_DWork.Delay_DSTATE_n > FlyByWire_P.Saturation_UpperSat_f) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_f;
  } else if (FlyByWire_DWork.Delay_DSTATE_n < FlyByWire_P.Saturation_LowerSat_aw) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_aw;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_n;
  }

  rtb_Limiterxi = FlyByWire_DWork.Delay_DSTATE_e * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_ce - rtb_Limitereta;
  rtb_Limitereta *= rtb_BusAssignment_c_pitch_data_computed_delta_eta_deg;
  rtb_BusAssignment_m_pitch_output_eta_deg = (rtb_Limiterxi + rtb_Limitereta) * rtb_Gain_pj + rtb_Sum5;
  ...
  if (FlyByWire_DWork.icLoad_b != 0) {
    FlyByWire_DWork.Delay_DSTATE_mx = rtb_eta_trim_deg_reset_deg - rtb_Limitereta;
  }

  rtb_Limitereta += FlyByWire_DWork.Delay_DSTATE_mx;
  if (rtb_Limitereta > FlyByWire_P.DiscreteTimeIntegratorVariableTs_UpperLimit_j) {
    ...
    FlyByWire_DWork.Delay_DSTATE_mx = rtb_Limitereta;
  }

  u1 = FlyByWire_DWork.Delay_DSTATE_mx - FlyByWire_DWork.Delay_DSTATE_b;
  ...
  FlyByWire_DWork.Delay_DSTATE_b += u1;
  ...
  } else if (rtb_in_flight < FlyByWire_P.Saturation_LowerSat_h5) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_h5;
  } else {
    rtb_Limitereta = rtb_in_flight;
  }

  u1 = rtb_Limitereta - FlyByWire_DWork.Delay_DSTATE_lx;
  ...
  rtb_Gain_pj = FlyByWire_U.in.data.engine_1_thrust_lbf - FlyByWire_U.in.data.engine_2_thrust_lbf;
  rtb_Limiterxi = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_l;
  rtb_Limiterxi1 = rtb_Limiterxi + FlyByWire_P.Constant_Value_cw;
  FlyByWire_DWork.Delay1_DSTATE_j = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_cw - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_j + (rtb_Gain_pj + FlyByWire_DWork.Delay_DSTATE_h) * (rtb_Limiterxi / rtb_Limiterxi1);
  rtb_Product_n = FlyByWire_DWork.Delay1_DSTATE_j * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
  ...
  rtb_Limitereta = u1 * FlyByWire_DWork.Delay_DSTATE_lx;
  rtb_Sum5 = FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_d * rtb_Limitereta * FlyByWire_U.in.time.dt;
  if ((FlyByWire_DWork.Delay_DSTATE_lx == 0.0) || (rtb_BusAssignment_a_sim_data_computed_tracking_mode_on != 0) ||
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch_Threshold_p) {
    ...
    rtb_Limiterxi = FlyByWire_DWork.Delay_DSTATE_ho;
  }

  rtb_Sum5 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_oj;
  ...
  FlyByWire_DWork.Delay_DSTATE_oj += rtb_Limiterxi1;
  u1 = rtb_Gain1_mp - FlyByWire_DWork.Delay_DSTATE_bg;
  ...
  FlyByWire_DWork.Delay_DSTATE_bg += u1;
  rtb_Limiterxi1 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_d;
  rtb_Sum5 = rtb_Limiterxi1 + FlyByWire_P.Constant_Value_i;
  FlyByWire_DWork.Delay1_DSTATE_o = 1.0 / rtb_Sum5 * (FlyByWire_P.Constant_Value_i - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_o + (rtb_Gain + FlyByWire_DWork.Delay_DSTATE_mu) * (rtb_Limiterxi1 / rtb_Sum5);
  rtb_Sum5 = FlyByWire_U.in.time.dt * FlyByWire_P.WashoutFilter_C1;
  rtb_Limiterxi = rtb_Sum5 + FlyByWire_P.Constant_Value_dw;
  rtb_Product3 = FlyByWire_P.Constant_Value_dw / rtb_Limiterxi;
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_e0 * rtb_Product3;
  rtb_Product3 *= rtb_Gain;
  FlyByWire_DWork.Delay1_DSTATE_m = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_dw - rtb_Sum5) *
    FlyByWire_DWork.Delay1_DSTATE_m + (rtb_Product3 - rtb_Limiterxi1);
  ...
  rtb_BusAssignment_e_roll_law_normal_xi_deg = ((FlyByWire_P.Gain3_Gain_k * FlyByWire_DWork.Delay_DSTATE_bg +
    FlyByWire_DWork.Delay_DSTATE_oj) - rtb_GainPhi) * FlyByWire_P.Gain2_Gain_i + FlyByWire_P.Gain1_Gain_mg * result[0] *
    FlyByWire_P.pKp_Gain;
  u1 = static_cast<real_T>(rtb_on_ground) - FlyByWire_DWork.Delay_DSTATE_eq;
  ...
  FlyByWire_DWork.Delay_DSTATE_eq += u1;
  if (FlyByWire_DWork.Delay_DSTATE_eq > FlyByWire_P.Saturation_UpperSat_lr) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_lr;
  } else if (FlyByWire_DWork.Delay_DSTATE_eq < FlyByWire_P.Saturation_LowerSat_e2) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_e2;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_eq;
  }

  rtb_Sum5 = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg * rtb_Limitereta;
  rtb_Sum1_e = FlyByWire_P.Constant_Value_hg - rtb_Limitereta;
  rtb_Limiterxi = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_c;
  rtb_Limiterxi1 = rtb_Limiterxi + FlyByWire_P.Constant_Value_c1;
  FlyByWire_DWork.Delay1_DSTATE_i = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_c1 - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_i + (FlyByWire_U.in.data.beta_deg + FlyByWire_DWork.Delay_DSTATE_g) * (rtb_Limiterxi /
    rtb_Limiterxi1);
  ...
  rtb_Limiterxi = rtb_Limitereta + FlyByWire_P.Constant_Value_f;
  FlyByWire_DWork.Delay1_DSTATE_a = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_f - rtb_Limitereta) *
    FlyByWire_DWork.Delay1_DSTATE_a + (rtb_Product3 + FlyByWire_DWork.Delay_DSTATE_az) * (rtb_Limitereta / rtb_Limiterxi);
  rtb_AND = ((rtb_BusAssignment_a_sim_data_computed_tracking_mode_on == 0) && (FlyByWire_U.in.data.autopilot_custom_on
              != 0.0));
  if (rtb_AND) {
    rtb_Limitereta = FlyByWire_DWork.Delay1_DSTATE_a;
  } else {
  ...
  u1 = (rtb_Limiterxi + FlyByWire_DWork.Delay_DSTATE_gt) - FlyByWire_DWork.Delay_DSTATE_km;
  ...
  FlyByWire_DWork.Delay_DSTATE_km += u1;
  ...
  } else if (FlyByWire_U.in.data.autopilot_custom_on < FlyByWire_P.Saturation_LowerSat_d) {
  ...
  u1 = (FlyByWire_DWork.Delay1_DSTATE_o - std::sin(FlyByWire_P.Gain1_Gain_br * FlyByWire_DWork.Delay_DSTATE_oj) *
  ...
  rtb_Limiterxi = FlyByWire_P.Gain6_Gain_k * FlyByWire_DWork.Delay1_DSTATE_m;
  ...
  rtb_Limitereta = ((rtb_Sum1_e * FlyByWire_DWork.Delay_DSTATE_km + rtb_Sum5) * rtb_Limitereta +
                    (FlyByWire_P.Constant_Value_mn - rtb_Limitereta) * FlyByWire_P.Constant3_Value) +
    ((FlyByWire_DWork.Delay_DSTATE_bg + u1) * FlyByWire_DWork.Delay_DSTATE_lx + rtb_Limiterxi);
  ...
  u1 = FlyByWire_DWork.Delay_DSTATE_fz - FlyByWire_DWork.Delay_DSTATE_h4;
  ...
  FlyByWire_DWork.Delay_DSTATE_h4 += u1;
  rtb_Sum1_e = rtb_Limitereta;
  rtb_Limiterxi = FlyByWire_DWork.Delay_DSTATE_lx + FlyByWire_U.in.data.autopilot_custom_on;
  ...
  if (rtb_Limitereta > FlyByWire_P.Saturation_UpperSat_hg) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_hg;
  } else {
    if (rtb_Limitereta < FlyByWire_P.Saturation_LowerSat_i) {
      rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_i;
    }
  }

  rtb_Sum5 = rtb_BusAssignment_e_roll_law_normal_xi_deg * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_l - rtb_Limitereta;
  ...
  if (rtb_Limiterxi > FlyByWire_P.Saturation_UpperSat_f4) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_f4;
  } else if (rtb_Limiterxi < FlyByWire_P.Saturation_LowerSat_oe) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_oe;
  } else {
    rtb_Limitereta = rtb_Limiterxi;
  }

  rtb_Limiterxi = rtb_Sum1_e * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_m5 - rtb_Limitereta;
  rtb_Limitereta *= rtb_Gain1_mp;
  rtb_Limiterxi += rtb_Limitereta;
  u1 = rtb_BusAssignment_m_pitch_output_eta_deg - FlyByWire_DWork.Delay_DSTATE_jm;
  ...
  FlyByWire_DWork.Delay_DSTATE_jm += u1;
  u1 = rtb_Sum5 - FlyByWire_DWork.Delay_DSTATE_j4;
  ...
  FlyByWire_DWork.Delay_DSTATE_j4 += u1;
  u1 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_li;
  ...
  FlyByWire_DWork.Delay_DSTATE_li += u1;
  ...
  FlyByWire_Y.out.pitch.data_computed.in_flight_gain = FlyByWire_DWork.Delay_DSTATE_f;
  FlyByWire_Y.out.pitch.data_computed.in_rotation_gain = FlyByWire_DWork.Delay_DSTATE_n;
  ...
  FlyByWire_Y.out.pitch.law_rotation.eta_deg = FlyByWire_DWork.Delay_DSTATE_e;
  ...
  FlyByWire_Y.out.roll.data_computed.in_flight_gain = FlyByWire_DWork.Delay_DSTATE_lx;
  ...
  FlyByWire_Y.out.roll.law_normal.Phi_c_deg = FlyByWire_DWork.Delay_DSTATE_oj;
  FlyByWire_Y.out.roll.law_normal.xi_deg = rtb_BusAssignment_e_roll_law_normal_xi_deg;
  FlyByWire_Y.out.roll.law_normal.zeta_deg = rtb_Sum1_e;
  FlyByWire_Y.out.roll.output.xi_deg = rtb_Sum5;
  FlyByWire_Y.out.roll.output.zeta_deg = rtb_Limiterxi;
  FlyByWire_Y.out.roll.output.zeta_trim_deg = FlyByWire_DWork.Delay_DSTATE_h4;
  rtb_Gain1_o = FlyByWire_P.Gaineta_Gain_d * FlyByWire_DWork.Delay_DSTATE_jm;
  ...
  rtb_Gain1_o = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_b;
  ...
  rtb_Gain1_o = FlyByWire_P.Gainxi_Gain_n * FlyByWire_DWork.Delay_DSTATE_j4;
  ...
  rtb_Gain1_o = FlyByWire_P.Gainxi1_Gain_e * FlyByWire_DWork.Delay_DSTATE_li;
  ...
  rtb_Gain1_o = FlyByWire_P.Gainxi2_Gain * FlyByWire_DWork.Delay_DSTATE_h4;
  ...
  FlyByWire_DWork.Delay_DSTATE_o = rtb_GainTheta;
  FlyByWire_DWork.Delay_DSTATE_c = rtb_Switch_c;
  FlyByWire_DWork.Delay_DSTATE_k = rtb_Saturation2;
  FlyByWire_DWork.Delay_DSTATE_p = rtb_Gain_l;
  FlyByWire_DWork.Delay_DSTATE_m = rtb_Gain_m;
  FlyByWire_DWork.Delay_DSTATE_a = rtb_Sum2;
  FlyByWire_DWork.icLoad = 0U;
  FlyByWire_DWork.icLoad_e = 0U;
  FlyByWire_DWork.icLoad_b = 0U;
  FlyByWire_DWork.Delay_DSTATE_h = rtb_Gain_pj;
  FlyByWire_DWork.icLoad_m = 0U;
  FlyByWire_DWork.Delay_DSTATE_mu = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_e0 = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_g = FlyByWire_U.in.data.beta_deg;
  FlyByWire_DWork.Delay_DSTATE_az = rtb_Product3;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_f = FlyByWire_P.RateLimiterVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_o = FlyByWire_P.Delay_InitialCondition_f;
  ...
  FlyByWire_DWork.Delay_DSTATE_du = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_h;
  FlyByWire_DWork.Delay_DSTATE_l = FlyByWire_P.RateLimiterVariableTs_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_c = FlyByWire_P.DiscreteDerivativeVariableTs1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_k = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_j = FlyByWire_P.RateLimiterVariableTs_InitialCondition_n;
  FlyByWire_DWork.Delay_DSTATE_p = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_d;
  FlyByWire_DWork.Delay_DSTATE_m = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_k;
  FlyByWire_DWork.Delay_DSTATE_a = FlyByWire_P.Delay_InitialCondition_k;
  FlyByWire_DWork.Delay1_DSTATE_k = FlyByWire_P.Delay1_InitialCondition_i;
  FlyByWire_DWork.icLoad = 1U;
  FlyByWire_DWork.icLoad_e = 1U;
  FlyByWire_DWork.icLoad_b = 1U;
  FlyByWire_DWork.Delay_DSTATE_b = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
  FlyByWire_DWork.Delay_DSTATE_lx = FlyByWire_P.RateLimiterVariableTs_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_h = FlyByWire_P.Delay_InitialCondition_c;
  FlyByWire_DWork.Delay1_DSTATE_j = FlyByWire_P.Delay1_InitialCondition_n;
  FlyByWire_DWork.Delay_DSTATE_oj = FlyByWire_P.RateLimiterVariableTs2_InitialCondition;
  FlyByWire_DWork.icLoad_m = 1U;
  FlyByWire_DWork.Delay_DSTATE_bg = FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc;
  FlyByWire_DWork.Delay_DSTATE_mu = FlyByWire_P.Delay_InitialCondition_o;
  FlyByWire_DWork.Delay1_DSTATE_o = FlyByWire_P.Delay1_InitialCondition_l;
  FlyByWire_DWork.Delay_DSTATE_e0 = FlyByWire_P.Delay_InitialCondition_fb;
  FlyByWire_DWork.Delay1_DSTATE_m = FlyByWire_P.Delay1_InitialCondition_nm;
  FlyByWire_DWork.Delay_DSTATE_eq = FlyByWire_P.RateLimiterVariableTs_InitialCondition_p;
  FlyByWire_DWork.Delay_DSTATE_km = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_g = FlyByWire_P.Delay_InitialCondition_p;
  FlyByWire_DWork.Delay1_DSTATE_i = FlyByWire_P.Delay1_InitialCondition_i3;
  FlyByWire_DWork.Delay_DSTATE_az = FlyByWire_P.Delay_InitialCondition_b;
  FlyByWire_DWork.Delay1_DSTATE_a = FlyByWire_P.Delay1_InitialCondition_f;
  FlyByWire_DWork.icLoad_i = 1U;
  FlyByWire_DWork.Delay_DSTATE_h4 = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i4;
  FlyByWire_DWork.icLoad_c = 1U;
  FlyByWire_DWork.Delay_DSTATE_jm = FlyByWire_P.RateLimitereta_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_j4 = FlyByWire_P.RateLimiterxi_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_li = FlyByWire_P.RateLimiterzeta_InitialCondition;
