...
void FlyByWireModelClass::step()
{
  ...
  FlyByWire_DWork.Delay1_DSTATE = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_e - rtb_Limiterxi) *
  ...
  rtb_Limiterxi1 = FlyByWire_U.in.data.autopilot_custom_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_p;
  ...
  rtb_Limiterxi1 = Theta - FlyByWire_DWork.Delay_DSTATE_j;
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold_k) {
    rtb_Sum5 = (FlyByWire_DWork.Delay_DSTATE_p - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    ...
    if (FlyByWire_DWork.Delay_DSTATE_j <= rtb_Saturation2) {
      ...
      if (FlyByWire_DWork.Delay_DSTATE_j >= rtb_Saturation2) {
        rtb_Saturation2 = FlyByWire_DWork.Delay_DSTATE_j;
      }
    }
  ...
  rtb_Limiterxi = (rtb_Gain1_b - FlyByWire_DWork.Delay_DSTATE_e3) / FlyByWire_U.in.time.dt + rtb_Limiterxi *
  ...
  if (FlyByWire_DWork.Delay_DSTATE_e > FlyByWire_P.Saturation_UpperSat_c) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_c;
  } else if (FlyByWire_DWork.Delay_DSTATE_e < FlyByWire_P.Saturation_LowerSat_ca) {
  ...
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_m - FlyByWire_DWork.Delay_DSTATE_b;
  ...
  rtb_Limiterxi1 = rtb_Limitereta - FlyByWire_DWork.Delay_DSTATE_h;
  ...
  FlyByWire_DWork.Delay1_DSTATE_c = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_n - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_c + (rtb_Sum_k + FlyByWire_DWork.Delay_DSTATE_l) * (rtb_Limiterxi / rtb_Limiterxi1);
  rtb_Product_o = FlyByWire_DWork.Delay1_DSTATE_c * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
  ...
  rtb_Limitereta = rtb_Limiterxi1 * FlyByWire_DWork.Delay_DSTATE_h;
  rtb_Sum5 = FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_d * rtb_Limitereta * FlyByWire_U.in.time.dt;
  if ((FlyByWire_DWork.Delay_DSTATE_h == 0.0) || (rtb_BusAssignment_a_sim_data_computed_tracking_mode_on != 0) ||
  ...
  rtb_Sum5 = rtb_Limiterxi1 - FlyByWire_DWork.Delay_DSTATE_h2;
  ...
  FlyByWire_DWork.Delay_DSTATE_h2 += u1;
  rtb_Limiterxi1 = rtb_Saturation2 - FlyByWire_DWork.Delay_DSTATE_b4;
  ...
  FlyByWire_DWork.Delay_DSTATE_b4 += rtb_Limiterxi1;
  rtb_Limiterxi1 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_d;
  rtb_Sum5 = rtb_Limiterxi1 + FlyByWire_P.Constant_Value_a;
  FlyByWire_DWork.Delay1_DSTATE_b = 1.0 / rtb_Sum5 * (FlyByWire_P.Constant_Value_a - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_b + (rtb_Gain + FlyByWire_DWork.Delay_DSTATE_hn) * (rtb_Limiterxi1 / rtb_Sum5);
  rtb_Sum5 = FlyByWire_U.in.time.dt * FlyByWire_P.WashoutFilter_C1;
  rtb_Limiterxi = rtb_Sum5 + FlyByWire_P.Constant_Value_k;
  rtb_Product3 = FlyByWire_P.Constant_Value_k / rtb_Limiterxi;
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_j5 * rtb_Product3;
  rtb_Product3 *= rtb_Gain;
  FlyByWire_DWork.Delay1_DSTATE_j = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_k - rtb_Sum5) *
    FlyByWire_DWork.Delay1_DSTATE_j + (rtb_Product3 - rtb_Limiterxi1);
  FlyByWire_Y.out.roll.law_normal.pk_c_deg_s = rtb_Limitereta;
  rtb_BusAssignment_e_roll_law_normal_xi_deg = ((FlyByWire_P.Gain3_Gain_k * FlyByWire_DWork.Delay_DSTATE_b4 +
    FlyByWire_DWork.Delay_DSTATE_h2) - rtb_GainPhi) * FlyByWire_P.Gain2_Gain_i + FlyByWire_P.Gain1_Gain_mg * result[0] *
    FlyByWire_P.pKp_Gain;
  rtb_Limiterxi1 = static_cast<real_T>(rtb_on_ground) - FlyByWire_DWork.Delay_DSTATE_pg;
  ...
  FlyByWire_DWork.Delay_DSTATE_pg += rtb_Limiterxi1;
  if (FlyByWire_DWork.Delay_DSTATE_pg > FlyByWire_P.Saturation_UpperSat_i) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_i;
  } else if (FlyByWire_DWork.Delay_DSTATE_pg < FlyByWire_P.Saturation_LowerSat_m) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_m;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_pg;
  }

  rtb_Sum5 = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg * rtb_Limitereta;
  rtb_Sum1_g = FlyByWire_P.Constant_Value_ma - rtb_Limitereta;
  rtb_Limiterxi = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_c;
  rtb_Limiterxi1 = rtb_Limiterxi + FlyByWire_P.Constant_Value_o;
  FlyByWire_DWork.Delay1_DSTATE_ci = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_o - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_ci + (FlyByWire_U.in.data.beta_deg + FlyByWire_DWork.Delay_DSTATE_db) * (rtb_Limiterxi
    / rtb_Limiterxi1);
  rtb_Product3 = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg + rtb_Product_o;
  rtb_Limitereta = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter1_C1;
  rtb_Limiterxi = rtb_Limitereta + FlyByWire_P.Constant_Value_j5;
  FlyByWire_DWork.Delay1_DSTATE_g = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_j5 - rtb_Limitereta) *
    FlyByWire_DWork.Delay1_DSTATE_g + (rtb_Product3 + FlyByWire_DWork.Delay_DSTATE_lg) * (rtb_Limitereta / rtb_Limiterxi);
  ...
  if (rtb_AND) {
    ...
    rtb_Limitereta = FlyByWire_DWork.Delay1_DSTATE_ci;
  }
  ...
  rtb_Limiterxi1 = (rtb_Limiterxi + FlyByWire_DWork.Delay_DSTATE_gt) - FlyByWire_DWork.Delay_DSTATE_n;
  ...
  } else if (FlyByWire_U.in.data.autopilot_custom_on < FlyByWire_P.Saturation_LowerSat_g) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_g;
  } else {
  ...
  rtb_Limiterxi1 = (FlyByWire_DWork.Delay1_DSTATE_b - std::sin(FlyByWire_P.Gain1_Gain_br *
    FlyByWire_DWork.Delay_DSTATE_h2) * FlyByWire_P.Constant2_Value_l * std::cos(FlyByWire_P.Gain1_Gain_c * rtb_GainTheta)
                    / (FlyByWire_P.Gain6_Gain * rtb_Limiterxi1) * FlyByWire_P.Gain_Gain_cd) * FlyByWire_P.Gain_Gain_h;
  rtb_Limiterxi = FlyByWire_P.Gain6_Gain_k * FlyByWire_DWork.Delay1_DSTATE_j;
  ...
  rtb_Limitereta = ((rtb_Sum1_g * FlyByWire_DWork.Delay_DSTATE_n + rtb_Sum5) * rtb_Limitereta +
                    (FlyByWire_P.Constant_Value_d - rtb_Limitereta) * FlyByWire_P.Constant3_Value) +
    ((FlyByWire_DWork.Delay_DSTATE_b4 + rtb_Limiterxi1) * FlyByWire_DWork.Delay_DSTATE_h + rtb_Limiterxi);
  ...
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_fz - FlyByWire_DWork.Delay_DSTATE_gy;
  ...
  FlyByWire_DWork.Delay_DSTATE_gy += rtb_Limiterxi1;
  rtb_Sum1_g = rtb_Limitereta;
  rtb_Limiterxi = FlyByWire_DWork.Delay_DSTATE_h + FlyByWire_U.in.data.autopilot_custom_on;
  ...
  rtb_Limitereta = FlyByWire_P.Constant_Value_gj - rtb_Limitereta;
  ...
  if (rtb_Limiterxi > FlyByWire_P.Saturation_UpperSat_lw) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_lw;
  } else if (rtb_Limiterxi < FlyByWire_P.Saturation_LowerSat_ns) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_ns;
  } else {
    rtb_Limitereta = rtb_Limiterxi;
  }

  rtb_Limiterxi = rtb_Sum1_g * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_dl - rtb_Limitereta;
  rtb_Limitereta *= rtb_Saturation2;
  rtb_Limiterxi += rtb_Limitereta;
  rtb_Limiterxi1 = rtb_Switch_c - FlyByWire_DWork.Delay_DSTATE_dn;
  ...
  FlyByWire_DWork.Delay_DSTATE_dn += rtb_Limiterxi1;
  rtb_Limiterxi1 = rtb_Sum5 - FlyByWire_DWork.Delay_DSTATE_c;
  ...
  rtb_Limiterxi1 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_lc;
  ...
  FlyByWire_DWork.Delay_DSTATE_lc += rtb_Limiterxi1;
  ...
  FlyByWire_Y.out.roll.data_computed.in_flight_gain = FlyByWire_DWork.Delay_DSTATE_h;
  FlyByWire_Y.out.roll.data_computed.zeta_trim_deg_should_write = (FlyByWire_U.in.data.autopilot_custom_on != 0.0);
  FlyByWire_Y.out.roll.data_computed.beta_target_deg = rtb_Product_o;
  FlyByWire_Y.out.roll.law_normal.Phi_c_deg = FlyByWire_DWork.Delay_DSTATE_h2;
  ...
  FlyByWire_Y.out.roll.output.zeta_trim_deg = FlyByWire_DWork.Delay_DSTATE_gy;
  rtb_Limiterxi1 = FlyByWire_P.Gaineta_Gain_d * FlyByWire_DWork.Delay_DSTATE_dn;
  ...
  rtb_Limiterxi1 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_b;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi_Gain_n * FlyByWire_DWork.Delay_DSTATE_c;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi1_Gain_e * FlyByWire_DWork.Delay_DSTATE_lc;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi2_Gain * FlyByWire_DWork.Delay_DSTATE_gy;
  ...
  FlyByWire_DWork.Delay_DSTATE_e3 = rtb_Gain1_b;
  FlyByWire_DWork.icLoad = 0U;
  FlyByWire_DWork.icLoad_b = 0U;
  FlyByWire_DWork.Delay_DSTATE_l = rtb_Sum_k;
  FlyByWire_DWork.icLoad_m = 0U;
  FlyByWire_DWork.Delay_DSTATE_hn = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_j5 = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_db = FlyByWire_U.in.data.beta_deg;
  FlyByWire_DWork.Delay_DSTATE_lg = rtb_Product3;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_g = FlyByWire_P.Delay_InitialCondition_b;
  ...
  FlyByWire_DWork.Delay_DSTATE_j = FlyByWire_P.RateLimiterVariableTs_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_e3 = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition;
  FlyByWire_DWork.icLoad = 1U;
  FlyByWire_DWork.icLoad_b = 1U;
  FlyByWire_DWork.Delay_DSTATE_b = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
  FlyByWire_DWork.Delay_DSTATE_h = FlyByWire_P.RateLimiterVariableTs_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_l = FlyByWire_P.Delay_InitialCondition_g;
  FlyByWire_DWork.Delay1_DSTATE_c = FlyByWire_P.Delay1_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_h2 = FlyByWire_P.RateLimiterVariableTs2_InitialCondition;
  FlyByWire_DWork.icLoad_m = 1U;
  FlyByWire_DWork.Delay_DSTATE_b4 = FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc;
  FlyByWire_DWork.Delay_DSTATE_hn = FlyByWire_P.Delay_InitialCondition_h;
  FlyByWire_DWork.Delay1_DSTATE_b = FlyByWire_P.Delay1_InitialCondition_l;
  FlyByWire_DWork.Delay_DSTATE_j5 = FlyByWire_P.Delay_InitialCondition_hs;
  FlyByWire_DWork.Delay1_DSTATE_j = FlyByWire_P.Delay1_InitialCondition_lh;
  FlyByWire_DWork.Delay_DSTATE_pg = FlyByWire_P.RateLimiterVariableTs_InitialCondition_p;
  FlyByWire_DWork.Delay_DSTATE_n = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_db = FlyByWire_P.Delay_InitialCondition_c;
  FlyByWire_DWork.Delay1_DSTATE_ci = FlyByWire_P.Delay1_InitialCondition_o;
  FlyByWire_DWork.Delay_DSTATE_lg = FlyByWire_P.Delay_InitialCondition_j;
  FlyByWire_DWork.Delay1_DSTATE_g = FlyByWire_P.Delay1_InitialCondition_i;
  FlyByWire_DWork.icLoad_i = 1U;
  FlyByWire_DWork.Delay_DSTATE_gy = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i4;
  FlyByWire_DWork.icLoad_c = 1U;
  FlyByWire_DWork.Delay_DSTATE_dn = FlyByWire_P.RateLimitereta_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_c = FlyByWire_P.RateLimiterxi_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_lc = FlyByWire_P.RateLimiterzeta_InitialCondition;
