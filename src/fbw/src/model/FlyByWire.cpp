...
void FlyByWireModelClass::step()
{
  ...
  if (FlyByWire_DWork.is_active_c1_FlyByWire == 0U) {
    ...
    if ((rtb_LimiteriH > 0.1) || (rtb_Limitereta > 0.1)) {
      FlyByWire_DWork.is_c1_FlyByWire = FlyByWire_IN_OnGround;
      rtb_on_ground = 1;
    } else {
      rtb_on_ground = 0;
    ...
    if ((rtb_LimiteriH == 0.0) && (rtb_Limitereta == 0.0)) {
  ...
  if (FlyByWire_DWork.is_active_c6_FlyByWire == 0U) {
    ...
    if ((FlyByWire_DWork.Delay_DSTATE_b == 0.0) && (FlyByWire_U.in.data.V_tas_kn > 70.0) &&
  ...
  rtb_Sum5 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1;
  rtb_Limiterxi1 = rtb_Sum5 + FlyByWire_P.Constant_Value_o;
  FlyByWire_DWork.Delay1_DSTATE = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_o - rtb_Sum5) *
    FlyByWire_DWork.Delay1_DSTATE + (rtb_GainTheta + FlyByWire_DWork.Delay_DSTATE_f) * (rtb_Sum5 / rtb_Limiterxi1);
  ...
  rtb_Limiterxi1 = rtb_ManualSwitch - FlyByWire_DWork.Delay_DSTATE_p;
  ...
  rtb_Limiterxi1 = Theta - FlyByWire_DWork.Delay_DSTATE_fz;
  ...
  if (FlyByWire_DWork.Delay_DSTATE_fz > FlyByWire_P.Saturation3_UpperSat) {
    rtb_Limiterxi1 = FlyByWire_P.Saturation3_UpperSat;
  } else if (FlyByWire_DWork.Delay_DSTATE_fz < FlyByWire_P.Saturation3_LowerSat) {
    rtb_Limiterxi1 = FlyByWire_P.Saturation3_LowerSat;
  } else {
    rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_fz;
  }

  rtb_Limitereta = look1_binlxpw(look2_binlxpw(rtb_GainTheta, FlyByWire_U.in.data.H_radio_ft,
    FlyByWire_P.uDLookupTable_bp01Data, FlyByWire_P.uDLookupTable_bp02Data, FlyByWire_P.uDLookupTable_tableData,
    FlyByWire_P.uDLookupTable_maxIndex, 5U) * rtb_Limiterxi1 + FlyByWire_DWork.Delay_DSTATE_fz,
    FlyByWire_P.PitchRateDemand_bp01Data, FlyByWire_P.PitchRateDemand_tableData, 2U);
  rtb_ManualSwitch = FlyByWire_P.DiscreteDerivativeVariableTs_Gain * rtb_Limitereta;
  rtb_LimiteriH = result[1] - rtb_Limitereta;
  rtb_Gain_h = FlyByWire_P.Gain_Gain_h * rtb_LimiteriH;
  rtb_Gain_k = FlyByWire_P.Gain1_Gain_i * rtb_LimiteriH * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_b;
  rtb_Sum2 = FlyByWire_P.Gain5_Gain * result_0[1] + result[1];
  rtb_LimiteriH = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_i;
  rtb_Sum5 = rtb_LimiteriH + FlyByWire_P.Constant_Value_c;
  FlyByWire_DWork.Delay1_DSTATE_p = 1.0 / rtb_Sum5 * (FlyByWire_P.Constant_Value_c - rtb_LimiteriH) *
    FlyByWire_DWork.Delay1_DSTATE_p + (rtb_Sum2 + FlyByWire_DWork.Delay_DSTATE_ml) * (rtb_LimiteriH / rtb_Sum5);
  rtb_LimiteriH = (((((rtb_Gain_k - FlyByWire_DWork.Delay_DSTATE_m) / FlyByWire_U.in.time.dt + rtb_Gain_h) *
                     FlyByWire_P.Gain1_Gain_a + (rtb_ManualSwitch - FlyByWire_DWork.Delay_DSTATE_d) /
  ...
  if (((Theta <= FlyByWire_P.Constant_Value_j) && (rtb_on_ground != 0)) || (FlyByWire_DWork.Delay_DSTATE_p == 0.0) ||
  ...
  if (rtb_on_ground > FlyByWire_P.Switch_Threshold_h) {
    if (rtb_BusAssignment_c_pitch_data_computed_delta_eta_deg > FlyByWire_P.Saturation_UpperSat_g) {
      ...
      rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_p;
    } else {
      rtb_Limitereta = rtb_BusAssignment_c_pitch_data_computed_delta_eta_deg;
    }
  } else {
    rtb_Limitereta = FlyByWire_P.Constant1_Value;
  }

  rtb_Gain_h = FlyByWire_DWork.Delay_DSTATE_e + rtb_Limitereta;
  if (rtb_GainPhi > FlyByWire_P.Saturation_UpperSat_d) {
    ...
    rtb_Gain1_h = FlyByWire_P.Saturation_LowerSat_pr;
  } else {
  ...
  rtb_Limiterxi1 = FlyByWire_U.in.data.autopilot_custom_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_h;
  ...
  rtb_Limiterxi1 = Theta - FlyByWire_DWork.Delay_DSTATE_b1;
  ...
  FlyByWire_DWork.Delay_DSTATE_b1 += rtb_Limiterxi1;
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold_k) {
    rtb_Sum5 = (FlyByWire_DWork.Delay_DSTATE_h - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    ...
    if (FlyByWire_DWork.Delay_DSTATE_b1 <= rtb_Saturation2) {
      ...
      if (FlyByWire_DWork.Delay_DSTATE_b1 >= rtb_Saturation2) {
        rtb_Saturation2 = FlyByWire_DWork.Delay_DSTATE_b1;
      }
    }
  ...
  rtb_Limitereta = rtb_LimiteriH - (look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.uDLookupTable_bp01Data_j,
    FlyByWire_P.uDLookupTable_tableData_l, 3U) / (FlyByWire_P.Gain5_Gain_g * rtb_Limiterxi1) + FlyByWire_P.Bias_Bias) *
    (rtb_Sum5 - rtb_Limitereta);
  rtb_Switch_c = rtb_Limitereta * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.DLUT_bp01Data,
    FlyByWire_P.DLUT_tableData, 1U) * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_e;
  rtb_Limitereta = ((rtb_Gain1_h - FlyByWire_DWork.Delay_DSTATE_c) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_l +
                    rtb_Limitereta * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.PLUT_bp01Data,
    FlyByWire_P.PLUT_tableData, 1U)) + (rtb_Switch_c - FlyByWire_DWork.Delay_DSTATE_fza) / FlyByWire_U.in.time.dt;
  if (rtb_Limitereta > FlyByWire_P.Saturation_UpperSat_j) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_j;
  } else {
    if (rtb_Limitereta < FlyByWire_P.Saturation_LowerSat_c) {
      rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_c;
    }
  }

  FlyByWire_Y.out.pitch.law_normal.nz_c_g = rtb_Sum5;
  FlyByWire_Y.out.pitch.law_normal.Cstar_g = rtb_LimiteriH;
  FlyByWire_Y.out.pitch.law_normal.eta_dot_deg_s = rtb_Limitereta;
  FlyByWire_Y.out.pitch.vote.eta_dot_deg_s = rtb_Limitereta;
  rtb_Limitereta *= FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_k;
  rtb_Limitereta *= FlyByWire_U.in.time.dt;
  ...
  if (FlyByWire_DWork.Delay_DSTATE_b > FlyByWire_P.Saturation_UpperSat_i) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_i;
  } else if (FlyByWire_DWork.Delay_DSTATE_b < FlyByWire_P.Saturation_LowerSat_er) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_er;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_b;
  }

  rtb_LimiteriH = FlyByWire_DWork.Delay_DSTATE_f1 * rtb_Limitereta;
  rtb_Saturation2 = FlyByWire_P.Constant_Value_hk - rtb_Limitereta;
  if (FlyByWire_DWork.Delay_DSTATE_p > FlyByWire_P.Saturation_UpperSat_db) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_db;
  } else if (FlyByWire_DWork.Delay_DSTATE_p < FlyByWire_P.Saturation_LowerSat_pri) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_pri;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_p;
  }

  rtb_Sum5 = rtb_Gain_h * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_p - rtb_Limitereta;
  rtb_Limitereta *= rtb_BusAssignment_c_pitch_data_computed_delta_eta_deg;
  rtb_BusAssignment_m_pitch_output_eta_deg = (rtb_Sum5 + rtb_Limitereta) * rtb_Saturation2 + rtb_LimiteriH;
  ...
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_mx - FlyByWire_DWork.Delay_DSTATE_eb;
  ...
  FlyByWire_DWork.Delay_DSTATE_eb += rtb_Limiterxi1;
  ...
  rtb_Limiterxi1 = rtb_Limitereta - FlyByWire_DWork.Delay_DSTATE_l;
  ...
  rtb_Sum5 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_l;
  rtb_Limiterxi1 = rtb_Sum5 + FlyByWire_P.Constant_Value_b;
  FlyByWire_DWork.Delay1_DSTATE_o = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_b - rtb_Sum5) *
    FlyByWire_DWork.Delay1_DSTATE_o + (rtb_Saturation2 + FlyByWire_DWork.Delay_DSTATE_f0) * (rtb_Sum5 / rtb_Limiterxi1);
  rtb_Product_j = FlyByWire_DWork.Delay1_DSTATE_o * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
  ...
  rtb_Limitereta = rtb_Limiterxi1 * FlyByWire_DWork.Delay_DSTATE_l;
  rtb_LimiteriH = FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_d * rtb_Limitereta * FlyByWire_U.in.time.dt;
  ...
  rtb_LimiteriH = rtb_Limiterxi1 - FlyByWire_DWork.Delay_DSTATE_g;
  ...
  rtb_Limiterxi1 = rtb_Gain1_l - FlyByWire_DWork.Delay_DSTATE_j;
  ...
  rtb_LimiteriH = rtb_Limiterxi1 + FlyByWire_P.Constant_Value_jk;
  FlyByWire_DWork.Delay1_DSTATE_oj = 1.0 / rtb_LimiteriH * (FlyByWire_P.Constant_Value_jk - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_oj + (rtb_Gain + FlyByWire_DWork.Delay_DSTATE_mu) * (rtb_Limiterxi1 / rtb_LimiteriH);
  rtb_LimiteriH = FlyByWire_U.in.time.dt * FlyByWire_P.WashoutFilter_C1;
  rtb_Sum5 = rtb_LimiteriH + FlyByWire_P.Constant_Value_n;
  rtb_Product3 = FlyByWire_P.Constant_Value_n / rtb_Sum5;
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_cq * rtb_Product3;
  rtb_Product3 *= rtb_Gain;
  FlyByWire_DWork.Delay1_DSTATE_h = 1.0 / rtb_Sum5 * (FlyByWire_P.Constant_Value_n - rtb_LimiteriH) *
    FlyByWire_DWork.Delay1_DSTATE_h + (rtb_Product3 - rtb_Limiterxi1);
  FlyByWire_Y.out.roll.law_normal.pk_c_deg_s = rtb_Limitereta;
  rtb_BusAssignment_e_roll_law_normal_xi_deg = ((FlyByWire_P.Gain3_Gain_k * FlyByWire_DWork.Delay_DSTATE_j +
    FlyByWire_DWork.Delay_DSTATE_g) - rtb_GainPhi) * FlyByWire_P.Gain2_Gain_i + FlyByWire_P.Gain1_Gain_mg * result[0] *
    FlyByWire_P.pKp_Gain;
  rtb_Limiterxi1 = static_cast<real_T>(rtb_on_ground) - FlyByWire_DWork.Delay_DSTATE_ip;
  ...
  FlyByWire_DWork.Delay_DSTATE_ip += rtb_Limiterxi1;
  if (FlyByWire_DWork.Delay_DSTATE_ip > FlyByWire_P.Saturation_UpperSat_m) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_m;
  } else if (FlyByWire_DWork.Delay_DSTATE_ip < FlyByWire_P.Saturation_LowerSat_m) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_m;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_ip;
  }

  rtb_LimiteriH = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg * rtb_Limitereta;
  rtb_Sum1_j = FlyByWire_P.Constant_Value_f - rtb_Limitereta;
  rtb_Sum5 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_c;
  rtb_Limiterxi1 = rtb_Sum5 + FlyByWire_P.Constant_Value_k;
  FlyByWire_DWork.Delay1_DSTATE_g = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_k - rtb_Sum5) *
    FlyByWire_DWork.Delay1_DSTATE_g + (FlyByWire_U.in.data.beta_deg + FlyByWire_DWork.Delay_DSTATE_fs) * (rtb_Sum5 /
    rtb_Limiterxi1);
  rtb_Product3 = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg + rtb_Product_j;
  rtb_Limitereta = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter1_C1;
  rtb_Sum5 = rtb_Limitereta + FlyByWire_P.Constant_Value_f2;
  FlyByWire_DWork.Delay1_DSTATE_gy = 1.0 / rtb_Sum5 * (FlyByWire_P.Constant_Value_f2 - rtb_Limitereta) *
    FlyByWire_DWork.Delay1_DSTATE_gy + (rtb_Product3 + FlyByWire_DWork.Delay_DSTATE_li) * (rtb_Limitereta / rtb_Sum5);
  rtb_AND = ((rtb_BusAssignment_a_sim_data_computed_tracking_mode_on == 0) && (FlyByWire_U.in.data.autopilot_custom_on
              != 0.0));
  if (rtb_AND) {
    rtb_Limitereta = FlyByWire_DWork.Delay1_DSTATE_gy;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay1_DSTATE_g;
  }

  rtb_Limitereta -= FlyByWire_DWork.Delay1_DSTATE_g;
  rtb_Sum5 = FlyByWire_P.Gain4_Gain_o * rtb_Limitereta;
  ...
  rtb_Limiterxi1 = (rtb_Sum5 + FlyByWire_DWork.Delay_DSTATE_gt) - FlyByWire_DWork.Delay_DSTATE_c1;
  ...
  FlyByWire_DWork.Delay_DSTATE_c1 += rtb_Limiterxi1;
  ...
  } else if (FlyByWire_U.in.data.autopilot_custom_on < FlyByWire_P.Saturation_LowerSat_lp) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_lp;
  } else {
  ...
  rtb_Limiterxi1 = (FlyByWire_DWork.Delay1_DSTATE_oj - std::sin(FlyByWire_P.Gain1_Gain_br *
    FlyByWire_DWork.Delay_DSTATE_g) * FlyByWire_P.Constant2_Value_l * std::cos(FlyByWire_P.Gain1_Gain_c * rtb_GainTheta)
                    / (FlyByWire_P.Gain6_Gain_j * rtb_Limiterxi1) * FlyByWire_P.Gain_Gain_cd) * FlyByWire_P.Gain_Gain_hk;
  rtb_Sum5 = FlyByWire_P.Gain6_Gain_k * FlyByWire_DWork.Delay1_DSTATE_h;
  ...
  if (rtb_Sum5 > FlyByWire_P.Saturation2_UpperSat_e) {
    rtb_Sum5 = FlyByWire_P.Saturation2_UpperSat_e;
  } else {
    if (rtb_Sum5 < FlyByWire_P.Saturation2_LowerSat_gp) {
      rtb_Sum5 = FlyByWire_P.Saturation2_LowerSat_gp;
    }
  }

  rtb_Limitereta = ((rtb_Sum1_j * FlyByWire_DWork.Delay_DSTATE_c1 + rtb_LimiteriH) * rtb_Limitereta +
                    (FlyByWire_P.Constant_Value_cz - rtb_Limitereta) * FlyByWire_P.Constant3_Value) +
    ((FlyByWire_DWork.Delay_DSTATE_j + rtb_Limiterxi1) * FlyByWire_DWork.Delay_DSTATE_l + rtb_Sum5);
  ...
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_fzn - FlyByWire_DWork.Delay_DSTATE_de;
  ...
  rtb_Sum1_j = rtb_Limitereta;
  rtb_Sum5 = FlyByWire_DWork.Delay_DSTATE_l + FlyByWire_U.in.data.autopilot_custom_on;
  if (rtb_Sum5 > FlyByWire_P.Saturation1_UpperSat_e) {
    rtb_Limitereta = FlyByWire_P.Saturation1_UpperSat_e;
  } else if (rtb_Sum5 < FlyByWire_P.Saturation1_LowerSat_l) {
    rtb_Limitereta = FlyByWire_P.Saturation1_LowerSat_l;
  } else {
    rtb_Limitereta = rtb_Sum5;
  }

  if (rtb_Limitereta > FlyByWire_P.Saturation_UpperSat_c) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_c;
  } else {
    if (rtb_Limitereta < FlyByWire_P.Saturation_LowerSat_ez) {
      rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_ez;
    }
  }

  rtb_LimiteriH = rtb_BusAssignment_e_roll_law_normal_xi_deg * rtb_Limitereta;
  ...
  if (rtb_Sum5 > FlyByWire_P.Saturation_UpperSat_eq) {
    rtb_Sum5 = FlyByWire_P.Saturation_UpperSat_eq;
  } else {
    if (rtb_Sum5 < FlyByWire_P.Saturation_LowerSat_n) {
      rtb_Sum5 = FlyByWire_P.Saturation_LowerSat_n;
    }
  }

  if (rtb_Sum5 > FlyByWire_P.Saturation_UpperSat_o) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_o;
  } else if (rtb_Sum5 < FlyByWire_P.Saturation_LowerSat_ha) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_ha;
  } else {
    rtb_Limitereta = rtb_Sum5;
  }

  rtb_Sum5 = rtb_Sum1_j * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_i0 - rtb_Limitereta;
  rtb_Limitereta *= rtb_Gain1_l;
  rtb_Sum5 += rtb_Limitereta;
  rtb_Limiterxi1 = rtb_BusAssignment_m_pitch_output_eta_deg - FlyByWire_DWork.Delay_DSTATE_n;
  ...
  rtb_Limiterxi1 = rtb_LimiteriH - FlyByWire_DWork.Delay_DSTATE_c4;
  ...
  FlyByWire_DWork.Delay_DSTATE_c4 += rtb_Limiterxi1;
  rtb_Limiterxi1 = rtb_Sum5 - FlyByWire_DWork.Delay_DSTATE_bb;
  ...
  FlyByWire_DWork.Delay_DSTATE_bb += rtb_Limiterxi1;
  ...
  FlyByWire_Y.out.pitch.data_computed.in_rotation_gain = FlyByWire_DWork.Delay_DSTATE_p;
  ...
  FlyByWire_Y.out.pitch.output.eta_trim_deg = FlyByWire_DWork.Delay_DSTATE_eb;
  ...
  FlyByWire_Y.out.roll.data_computed.beta_target_deg = rtb_Product_j;
  FlyByWire_Y.out.roll.law_normal.Phi_c_deg = FlyByWire_DWork.Delay_DSTATE_g;
  FlyByWire_Y.out.roll.law_normal.xi_deg = rtb_BusAssignment_e_roll_law_normal_xi_deg;
  FlyByWire_Y.out.roll.law_normal.zeta_deg = rtb_Sum1_j;
  FlyByWire_Y.out.roll.output.xi_deg = rtb_LimiteriH;
  FlyByWire_Y.out.roll.output.zeta_deg = rtb_Sum5;
  FlyByWire_Y.out.roll.output.zeta_trim_deg = FlyByWire_DWork.Delay_DSTATE_de;
  rtb_Limiterxi1 = FlyByWire_P.Gaineta_Gain_d * FlyByWire_DWork.Delay_DSTATE_n;
  ...
  rtb_Limiterxi1 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_eb;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi_Gain_n * FlyByWire_DWork.Delay_DSTATE_c4;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi1_Gain_e * FlyByWire_DWork.Delay_DSTATE_bb;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi2_Gain * FlyByWire_DWork.Delay_DSTATE_de;
  ...
  FlyByWire_DWork.Delay_DSTATE_f = rtb_GainTheta;
  FlyByWire_DWork.Delay_DSTATE_d = rtb_ManualSwitch;
  FlyByWire_DWork.Delay_DSTATE_m = rtb_Gain_k;
  FlyByWire_DWork.Delay_DSTATE_ml = rtb_Sum2;
  FlyByWire_DWork.icLoad = 0U;
  FlyByWire_DWork.Delay_DSTATE_c = rtb_Gain1_h;
  FlyByWire_DWork.Delay_DSTATE_fza = rtb_Switch_c;
  FlyByWire_DWork.icLoad_e = 0U;
  FlyByWire_DWork.icLoad_b = 0U;
  FlyByWire_DWork.Delay_DSTATE_f0 = rtb_Saturation2;
  FlyByWire_DWork.icLoad_m = 0U;
  FlyByWire_DWork.Delay_DSTATE_mu = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_cq = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_fs = FlyByWire_U.in.data.beta_deg;
  FlyByWire_DWork.Delay_DSTATE_li = rtb_Product3;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_f = FlyByWire_P.Delay_InitialCondition_j;
  FlyByWire_DWork.Delay1_DSTATE = FlyByWire_P.Delay1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_p = FlyByWire_P.RateLimiterVariableTs1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_i = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_fz = FlyByWire_P.RateLimiterVariableTs_InitialCondition_n;
  ...
  FlyByWire_DWork.Delay_DSTATE_ml = FlyByWire_P.Delay_InitialCondition_k;
  FlyByWire_DWork.Delay1_DSTATE_p = FlyByWire_P.Delay1_InitialCondition_h;
  FlyByWire_DWork.icLoad = 1U;
  FlyByWire_DWork.Delay_DSTATE_h = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_h;
  FlyByWire_DWork.Delay_DSTATE_b1 = FlyByWire_P.RateLimiterVariableTs_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_c = FlyByWire_P.DiscreteDerivativeVariableTs1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_fza = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_c;
  FlyByWire_DWork.icLoad_e = 1U;
  FlyByWire_DWork.icLoad_b = 1U;
  FlyByWire_DWork.Delay_DSTATE_eb = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
  FlyByWire_DWork.Delay_DSTATE_l = FlyByWire_P.RateLimiterVariableTs_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_f0 = FlyByWire_P.Delay_InitialCondition_b;
  FlyByWire_DWork.Delay1_DSTATE_o = FlyByWire_P.Delay1_InitialCondition_hh;
  FlyByWire_DWork.Delay_DSTATE_g = FlyByWire_P.RateLimiterVariableTs2_InitialCondition;
  FlyByWire_DWork.icLoad_m = 1U;
  FlyByWire_DWork.Delay_DSTATE_j = FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc;
  FlyByWire_DWork.Delay_DSTATE_mu = FlyByWire_P.Delay_InitialCondition_i;
  FlyByWire_DWork.Delay1_DSTATE_oj = FlyByWire_P.Delay1_InitialCondition_a;
  ...
  FlyByWire_DWork.Delay_DSTATE_ip = FlyByWire_P.RateLimiterVariableTs_InitialCondition_p;
  FlyByWire_DWork.Delay_DSTATE_c1 = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_fs = FlyByWire_P.Delay_InitialCondition_bk;
  FlyByWire_DWork.Delay1_DSTATE_g = FlyByWire_P.Delay1_InitialCondition_k;
  FlyByWire_DWork.Delay_DSTATE_li = FlyByWire_P.Delay_InitialCondition_be;
  FlyByWire_DWork.Delay1_DSTATE_gy = FlyByWire_P.Delay1_InitialCondition_g;
  FlyByWire_DWork.icLoad_i = 1U;
  FlyByWire_DWork.Delay_DSTATE_de = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i4;
  FlyByWire_DWork.icLoad_c = 1U;
  FlyByWire_DWork.Delay_DSTATE_n = FlyByWire_P.RateLimitereta_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_c4 = FlyByWire_P.RateLimiterxi_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_bb = FlyByWire_P.RateLimiterzeta_InitialCondition;
