...
void FlyByWireModelClass::step()
{
  ...
  rtb_Limiterxi1 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_c;
  ...
  if (FlyByWire_DWork.is_active_c6_FlyByWire == 0U) {
    ...
    if ((FlyByWire_DWork.Delay_DSTATE_c == 0.0) && (FlyByWire_U.in.data.V_tas_kn > 100.0) &&
  ...
  FlyByWire_DWork.Delay1_DSTATE = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_o - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE + (rtb_GainTheta + FlyByWire_DWork.Delay_DSTATE_n) * (rtb_Limiterxi / rtb_Limiterxi1);
  ...
  rtb_Limiterxi1 = rtb_ManualSwitch - FlyByWire_DWork.Delay_DSTATE_l;
  ...
  if (rtb_GainPhi > FlyByWire_P.Saturation_UpperSat_d) {
    rtb_Gain1_h = FlyByWire_P.Saturation_UpperSat_d;
  } else if (rtb_GainPhi < FlyByWire_P.Saturation_LowerSat_p) {
    rtb_Gain1_h = FlyByWire_P.Saturation_LowerSat_p;
  } else {
    rtb_Gain1_h = rtb_GainPhi;
  }

  rtb_Limitereta = std::cos(FlyByWire_P.Gain1_Gain_p * rtb_GainTheta) / std::cos(FlyByWire_P.Gain1_Gain_b * rtb_Gain1_h);
  rtb_Limiterxi1 = FlyByWire_U.in.data.autopilot_custom_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_no;
  ...
  FlyByWire_DWork.Delay_DSTATE_no += rtb_Limiterxi1;
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold_k) {
    rtb_Sum5 = (FlyByWire_DWork.Delay_DSTATE_no - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    ...
    if (FlyByWire_DWork.Delay_DSTATE_f <= rtb_Saturation2) {
      ...
      if (FlyByWire_DWork.Delay_DSTATE_f >= rtb_Saturation2) {
        rtb_Saturation2 = FlyByWire_DWork.Delay_DSTATE_f;
      }
    }
  ...
  rtb_Gain1_h = rtb_Sum5 - rtb_Limitereta;
  ...
  rtb_Limiterxi = rtb_Limitereta - (FlyByWire_P.Vmms_Value / (FlyByWire_P.Gain5_Gain * rtb_Limiterxi) +
    FlyByWire_P.Bias_Bias) * rtb_Gain1_h;
  rtb_Gain1_h = FlyByWire_P.DiscreteDerivativeVariableTs1_Gain * result[1];
  rtb_Switch_c = rtb_Limiterxi * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.DLUT_bp01Data,
    FlyByWire_P.DLUT_tableData, 1U) * FlyByWire_P.DiscreteDerivativeVariableTs_Gain;
  rtb_Limiterxi = ((rtb_Gain1_h - FlyByWire_DWork.Delay_DSTATE_cq) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_l +
                   rtb_Limiterxi * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.PLUT_bp01Data,
    FlyByWire_P.PLUT_tableData, 1U)) + (rtb_Switch_c - FlyByWire_DWork.Delay_DSTATE_d) / FlyByWire_U.in.time.dt;
  ...
  u1 = FlyByWire_P.RateLimiterVariableTs_up_e * FlyByWire_U.in.time.dt;
  if (rtb_Limiterxi1 < u1) {
    u1 = rtb_Limiterxi1;
  }

  rtb_Limiterxi1 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs_lo_fe;
  if (u1 > rtb_Limiterxi1) {
    rtb_Limiterxi1 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_g += rtb_Limiterxi1;
  rtb_Limitereta = look1_binlxpw(FlyByWire_DWork.Delay_DSTATE_g, FlyByWire_P.PitchRateDemand_bp01Data,
    FlyByWire_P.PitchRateDemand_tableData, 2U);
  rtb_Saturation2 = FlyByWire_P.Gain5_Gain_b * result_0[1] + result[1];
  rtb_Sum5 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_d;
  rtb_Limiterxi = rtb_Sum5 + FlyByWire_P.Constant_Value_l;
  FlyByWire_DWork.Delay1_DSTATE_p = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_l - rtb_Sum5) *
    FlyByWire_DWork.Delay1_DSTATE_p + (rtb_Saturation2 + FlyByWire_DWork.Delay_DSTATE_i) * (rtb_Sum5 / rtb_Limiterxi);
  rtb_Gain_n4 = FlyByWire_P.DiscreteDerivativeVariableTs_Gain_m * rtb_Limitereta;
  rtb_Sum5 = result[1] - rtb_Limitereta;
  rtb_Gain_ol = FlyByWire_P.Gain1_Gain_pn * rtb_Sum5 * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_a;
  rtb_Limiterxi1 = (rtb_Gain_ol - FlyByWire_DWork.Delay_DSTATE_la) / FlyByWire_U.in.time.dt + FlyByWire_P.Gain_Gain_do *
    rtb_Sum5;
  if (rtb_Limiterxi1 > FlyByWire_P.Saturation_UpperSat_a) {
    rtb_Limiterxi1 = FlyByWire_P.Saturation_UpperSat_a;
  } else {
    if (rtb_Limiterxi1 < FlyByWire_P.Saturation_LowerSat_k) {
      rtb_Limiterxi1 = FlyByWire_P.Saturation_LowerSat_k;
    }
  }

  rtb_Sum5 = ((((rtb_Gain_n4 - FlyByWire_DWork.Delay_DSTATE_am) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_h +
                FlyByWire_P.Gain1_Gain_c * rtb_Limiterxi1) + (FlyByWire_DWork.Delay1_DSTATE_p - rtb_Limitereta) *
               FlyByWire_P.Gain4_Gain_m) + FlyByWire_P.Gain6_Gain * result_0[1]) *
    FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_l * FlyByWire_U.in.time.dt;
  ...
  if (FlyByWire_DWork.icLoad_m != 0) {
    FlyByWire_DWork.Delay_DSTATE_gf = rtb_Gainpk4 - rtb_Sum5;
  }

  rtb_Sum5 += FlyByWire_DWork.Delay_DSTATE_gf;
  FlyByWire_Y.out.pitch.law_rotation.qk_c_deg_s = rtb_Limitereta;
  if (rtb_Sum5 > FlyByWire_P.DiscreteTimeIntegratorVariableTs_UpperLimit_a) {
    FlyByWire_DWork.Delay_DSTATE_gf = FlyByWire_P.DiscreteTimeIntegratorVariableTs_UpperLimit_a;
  } else if (rtb_Sum5 < FlyByWire_P.DiscreteTimeIntegratorVariableTs_LowerLimit_k) {
    FlyByWire_DWork.Delay_DSTATE_gf = FlyByWire_P.DiscreteTimeIntegratorVariableTs_LowerLimit_k;
  } else {
    FlyByWire_DWork.Delay_DSTATE_gf = rtb_Sum5;
  }

  if (FlyByWire_DWork.Delay_DSTATE_c > FlyByWire_P.Saturation_UpperSat_k) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_k;
  } else if (FlyByWire_DWork.Delay_DSTATE_c < FlyByWire_P.Saturation_LowerSat_cb) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_cb;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_c;
  }

  rtb_Sum5 = FlyByWire_DWork.Delay_DSTATE_f1 * rtb_Limitereta;
  rtb_Sum1_d = FlyByWire_P.Constant_Value_n - rtb_Limitereta;
  if (FlyByWire_DWork.Delay_DSTATE_l > FlyByWire_P.Saturation_UpperSat_o) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_o;
  } else if (FlyByWire_DWork.Delay_DSTATE_l < FlyByWire_P.Saturation_LowerSat_f) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_f;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_l;
  }

  rtb_Limiterxi = FlyByWire_DWork.Delay_DSTATE_gf * rtb_Limitereta;
  ...
  rtb_BusAssignment_m_pitch_output_eta_deg = (rtb_Limiterxi + rtb_Limitereta) * rtb_Sum1_d + rtb_Sum5;
  ...
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_m - FlyByWire_DWork.Delay_DSTATE_cs;
  ...
  FlyByWire_DWork.Delay_DSTATE_cs += rtb_Limiterxi1;
  ...
  if (rtb_Gain1_l > rtb_Limitereta) {
    rtb_Gain1_l = rtb_Limitereta;
  } else {
  ...
  rtb_Limiterxi1 = rtb_Limitereta - FlyByWire_DWork.Delay_DSTATE_p;
  ...
  rtb_Sum1_d = FlyByWire_U.in.data.engine_1_thrust_lbf - FlyByWire_U.in.data.engine_2_thrust_lbf;
  rtb_Limiterxi = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_l;
  rtb_Limiterxi1 = rtb_Limiterxi + FlyByWire_P.Constant_Value_p;
  FlyByWire_DWork.Delay1_DSTATE_k = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_p - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_k + (rtb_Sum1_d + FlyByWire_DWork.Delay_DSTATE_b) * (rtb_Limiterxi / rtb_Limiterxi1);
  rtb_Product_a = FlyByWire_DWork.Delay1_DSTATE_k * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
  ...
  rtb_Limitereta = rtb_Limiterxi1 * FlyByWire_DWork.Delay_DSTATE_p;
  rtb_Sum5 = FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_d * rtb_Limitereta * FlyByWire_U.in.time.dt;
  if ((FlyByWire_DWork.Delay_DSTATE_p == 0.0) || (rtb_BusAssignment_a_sim_data_computed_tracking_mode_on != 0) ||
      (FlyByWire_U.in.data.autopilot_custom_on != 0.0)) {
    FlyByWire_DWork.icLoad_ms = 1U;
  }

  if (FlyByWire_DWork.icLoad_ms != 0) {
  ...
  } else if (rtb_Sum5 < FlyByWire_P.DiscreteTimeIntegratorVariableTs_LowerLimit_kc) {
    FlyByWire_DWork.Delay_DSTATE_h = FlyByWire_P.DiscreteTimeIntegratorVariableTs_LowerLimit_kc;
  } else {
  ...
  rtb_Sum5 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_px;
  ...
  FlyByWire_DWork.Delay_DSTATE_px += u1;
  rtb_Limiterxi1 = rtb_Gain1_l - FlyByWire_DWork.Delay_DSTATE_k;
  ...
  rtb_Limiterxi1 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_du;
  rtb_Sum5 = rtb_Limiterxi1 + FlyByWire_P.Constant_Value_gr;
  FlyByWire_DWork.Delay1_DSTATE_ko = 1.0 / rtb_Sum5 * (FlyByWire_P.Constant_Value_gr - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_ko + (rtb_Gain + FlyByWire_DWork.Delay_DSTATE_in) * (rtb_Limiterxi1 / rtb_Sum5);
  rtb_Sum5 = FlyByWire_U.in.time.dt * FlyByWire_P.WashoutFilter_C1;
  rtb_Limiterxi = rtb_Sum5 + FlyByWire_P.Constant_Value_c;
  rtb_Product3 = FlyByWire_P.Constant_Value_c / rtb_Limiterxi;
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_mr * rtb_Product3;
  rtb_Product3 *= rtb_Gain;
  FlyByWire_DWork.Delay1_DSTATE_c = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_c - rtb_Sum5) *
    FlyByWire_DWork.Delay1_DSTATE_c + (rtb_Product3 - rtb_Limiterxi1);
  FlyByWire_Y.out.roll.law_normal.pk_c_deg_s = rtb_Limitereta;
  rtb_BusAssignment_e_roll_law_normal_xi_deg = ((FlyByWire_P.Gain3_Gain_k * FlyByWire_DWork.Delay_DSTATE_k +
    FlyByWire_DWork.Delay_DSTATE_px) - rtb_GainPhi) * FlyByWire_P.Gain2_Gain_i + FlyByWire_P.Gain1_Gain_mg * result[0] *
    FlyByWire_P.pKp_Gain;
  rtb_Limiterxi1 = static_cast<real_T>(rtb_on_ground) - FlyByWire_DWork.Delay_DSTATE_dk;
  ...
  FlyByWire_DWork.Delay_DSTATE_dk += rtb_Limiterxi1;
  if (FlyByWire_DWork.Delay_DSTATE_dk > FlyByWire_P.Saturation_UpperSat_ag) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_ag;
  } else if (FlyByWire_DWork.Delay_DSTATE_dk < FlyByWire_P.Saturation_LowerSat_fw) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_fw;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_dk;
  }

  rtb_Sum5 = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg * rtb_Limitereta;
  rtb_Sum1_k = FlyByWire_P.Constant_Value_f - rtb_Limitereta;
  rtb_Limiterxi = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_c;
  rtb_Limiterxi1 = rtb_Limiterxi + FlyByWire_P.Constant_Value_ov;
  FlyByWire_DWork.Delay1_DSTATE_n = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_ov - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_n + (FlyByWire_U.in.data.beta_deg + FlyByWire_DWork.Delay_DSTATE_kc) * (rtb_Limiterxi /
    rtb_Limiterxi1);
  ...
  rtb_Limiterxi = rtb_Limitereta + FlyByWire_P.Constant_Value_jp;
  FlyByWire_DWork.Delay1_DSTATE_pm = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_jp - rtb_Limitereta) *
    FlyByWire_DWork.Delay1_DSTATE_pm + (rtb_Product3 + FlyByWire_DWork.Delay_DSTATE_dy) * (rtb_Limitereta /
    rtb_Limiterxi);
  rtb_AND = ((rtb_BusAssignment_a_sim_data_computed_tracking_mode_on == 0) && (FlyByWire_U.in.data.autopilot_custom_on
              != 0.0));
  if (rtb_AND) {
    rtb_Limitereta = FlyByWire_DWork.Delay1_DSTATE_pm;
  } else {
  ...
  rtb_Limiterxi1 = (rtb_Limiterxi + FlyByWire_DWork.Delay_DSTATE_gt) - FlyByWire_DWork.Delay_DSTATE_e;
  ...
  } else if (FlyByWire_U.in.data.autopilot_custom_on < FlyByWire_P.Saturation_LowerSat_ps) {
  ...
  rtb_Limiterxi1 = (FlyByWire_DWork.Delay1_DSTATE_ko - std::sin(FlyByWire_P.Gain1_Gain_br *
    FlyByWire_DWork.Delay_DSTATE_px) * FlyByWire_P.Constant2_Value_l * std::cos(FlyByWire_P.Gain1_Gain_cq *
    rtb_GainTheta) / (FlyByWire_P.Gain6_Gain_j * rtb_Limiterxi) * FlyByWire_P.Gain_Gain_cd) * FlyByWire_P.Gain_Gain_h;
  ...
  rtb_Limitereta = ((rtb_Sum1_k * FlyByWire_DWork.Delay_DSTATE_e + rtb_Sum5) * rtb_Limitereta +
                    (FlyByWire_P.Constant_Value_ny - rtb_Limitereta) * FlyByWire_P.Constant3_Value) +
    ((FlyByWire_DWork.Delay_DSTATE_k + rtb_Limiterxi1) * FlyByWire_DWork.Delay_DSTATE_p + rtb_Limiterxi);
  ...
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_fz - FlyByWire_DWork.Delay_DSTATE_o;
  ...
  rtb_Sum1_k = rtb_Limitereta;
  rtb_Limiterxi = FlyByWire_DWork.Delay_DSTATE_p + FlyByWire_U.in.data.autopilot_custom_on;
  ...
  if (rtb_Limitereta > FlyByWire_P.Saturation_UpperSat_ly) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_ly;
  } else {
    if (rtb_Limitereta < FlyByWire_P.Saturation_LowerSat_j) {
      rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_j;
    }
  }

  rtb_Sum5 = rtb_BusAssignment_e_roll_law_normal_xi_deg * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_bs - rtb_Limitereta;
  ...
  if (rtb_Limiterxi > FlyByWire_P.Saturation_UpperSat_em) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_em;
  } else if (rtb_Limiterxi < FlyByWire_P.Saturation_LowerSat_a0) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_a0;
  } else {
    rtb_Limitereta = rtb_Limiterxi;
  }

  rtb_Limiterxi = rtb_Sum1_k * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_d - rtb_Limitereta;
  rtb_Limitereta *= rtb_Gain1_l;
  rtb_Limiterxi += rtb_Limitereta;
  rtb_Limiterxi1 = rtb_BusAssignment_m_pitch_output_eta_deg - FlyByWire_DWork.Delay_DSTATE_nq;
  ...
  FlyByWire_DWork.Delay_DSTATE_nq += rtb_Limiterxi1;
  rtb_Limiterxi1 = rtb_Sum5 - FlyByWire_DWork.Delay_DSTATE_kq;
  ...
  FlyByWire_DWork.Delay_DSTATE_kq += rtb_Limiterxi1;
  rtb_Limiterxi1 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_cc;
  ...
  FlyByWire_DWork.Delay_DSTATE_cc += rtb_Limiterxi1;
  ...
  FlyByWire_Y.out.pitch.data_computed.in_rotation_gain = FlyByWire_DWork.Delay_DSTATE_l;
  ...
  FlyByWire_Y.out.pitch.law_rotation.eta_deg = FlyByWire_DWork.Delay_DSTATE_gf;
  ...
  FlyByWire_Y.out.pitch.output.eta_trim_deg = FlyByWire_DWork.Delay_DSTATE_cs;
  ...
  FlyByWire_Y.out.roll.data_computed.in_flight_gain = FlyByWire_DWork.Delay_DSTATE_p;
  ...
  FlyByWire_Y.out.roll.law_normal.Phi_c_deg = FlyByWire_DWork.Delay_DSTATE_px;
  FlyByWire_Y.out.roll.law_normal.xi_deg = rtb_BusAssignment_e_roll_law_normal_xi_deg;
  FlyByWire_Y.out.roll.law_normal.zeta_deg = rtb_Sum1_k;
  FlyByWire_Y.out.roll.output.xi_deg = rtb_Sum5;
  FlyByWire_Y.out.roll.output.zeta_deg = rtb_Limiterxi;
  FlyByWire_Y.out.roll.output.zeta_trim_deg = FlyByWire_DWork.Delay_DSTATE_o;
  rtb_Limiterxi1 = FlyByWire_P.Gaineta_Gain_d * FlyByWire_DWork.Delay_DSTATE_nq;
  ...
  rtb_Limiterxi1 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_cs;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi_Gain_n * FlyByWire_DWork.Delay_DSTATE_kq;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi1_Gain_e * FlyByWire_DWork.Delay_DSTATE_cc;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi2_Gain * FlyByWire_DWork.Delay_DSTATE_o;
  ...
  FlyByWire_DWork.Delay_DSTATE_n = rtb_GainTheta;
  FlyByWire_DWork.Delay_DSTATE_cq = rtb_Gain1_h;
  FlyByWire_DWork.Delay_DSTATE_d = rtb_Switch_c;
  FlyByWire_DWork.icLoad = 0U;
  FlyByWire_DWork.Delay_DSTATE_i = rtb_Saturation2;
  FlyByWire_DWork.Delay_DSTATE_am = rtb_Gain_n4;
  FlyByWire_DWork.Delay_DSTATE_la = rtb_Gain_ol;
  FlyByWire_DWork.icLoad_m = 0U;
  FlyByWire_DWork.icLoad_b = 0U;
  FlyByWire_DWork.Delay_DSTATE_b = rtb_Sum1_d;
  FlyByWire_DWork.icLoad_ms = 0U;
  FlyByWire_DWork.Delay_DSTATE_in = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_mr = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_kc = FlyByWire_U.in.data.beta_deg;
  FlyByWire_DWork.Delay_DSTATE_dy = rtb_Product3;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_n = FlyByWire_P.Delay_InitialCondition_d;
  ...
  FlyByWire_DWork.Delay_DSTATE_no = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_h;
  FlyByWire_DWork.Delay_DSTATE_f = FlyByWire_P.RateLimiterVariableTs_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_cq = FlyByWire_P.DiscreteDerivativeVariableTs1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_d = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition;
  FlyByWire_DWork.icLoad = 1U;
  FlyByWire_DWork.Delay_DSTATE_g = FlyByWire_P.RateLimiterVariableTs_InitialCondition_k;
  FlyByWire_DWork.Delay_DSTATE_i = FlyByWire_P.Delay_InitialCondition_p;
  FlyByWire_DWork.Delay1_DSTATE_p = FlyByWire_P.Delay1_InitialCondition_i;
  FlyByWire_DWork.Delay_DSTATE_am = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_k;
  FlyByWire_DWork.Delay_DSTATE_la = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_p;
  FlyByWire_DWork.icLoad_m = 1U;
  FlyByWire_DWork.icLoad_b = 1U;
  FlyByWire_DWork.Delay_DSTATE_cs = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
  FlyByWire_DWork.Delay_DSTATE_p = FlyByWire_P.RateLimiterVariableTs_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_b = FlyByWire_P.Delay_InitialCondition_a;
  FlyByWire_DWork.Delay1_DSTATE_k = FlyByWire_P.Delay1_InitialCondition_e;
  FlyByWire_DWork.Delay_DSTATE_px = FlyByWire_P.RateLimiterVariableTs2_InitialCondition;
  FlyByWire_DWork.icLoad_ms = 1U;
  FlyByWire_DWork.Delay_DSTATE_k = FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc;
  FlyByWire_DWork.Delay_DSTATE_in = FlyByWire_P.Delay_InitialCondition_n;
  FlyByWire_DWork.Delay1_DSTATE_ko = FlyByWire_P.Delay1_InitialCondition_n;
  FlyByWire_DWork.Delay_DSTATE_mr = FlyByWire_P.Delay_InitialCondition_e;
  FlyByWire_DWork.Delay1_DSTATE_c = FlyByWire_P.Delay1_InitialCondition_g;
  FlyByWire_DWork.Delay_DSTATE_dk = FlyByWire_P.RateLimiterVariableTs_InitialCondition_p;
  FlyByWire_DWork.Delay_DSTATE_e = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_kc = FlyByWire_P.Delay_InitialCondition_m;
  FlyByWire_DWork.Delay1_DSTATE_n = FlyByWire_P.Delay1_InitialCondition_k;
  FlyByWire_DWork.Delay_DSTATE_dy = FlyByWire_P.Delay_InitialCondition_o;
  FlyByWire_DWork.Delay1_DSTATE_pm = FlyByWire_P.Delay1_InitialCondition_g4;
  FlyByWire_DWork.icLoad_i = 1U;
  FlyByWire_DWork.Delay_DSTATE_o = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i4;
  FlyByWire_DWork.icLoad_c = 1U;
  FlyByWire_DWork.Delay_DSTATE_nq = FlyByWire_P.RateLimitereta_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_kq = FlyByWire_P.RateLimiterxi_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_cc = FlyByWire_P.RateLimiterzeta_InitialCondition;
