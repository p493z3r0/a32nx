...
void FlyByWireModelClass::step()
{
  ...
  rtb_Limiterxi1 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_e;
  ...
  if (FlyByWire_DWork.is_active_c6_FlyByWire == 0U) {
    ...
    if ((FlyByWire_DWork.Delay_DSTATE_e == 0.0) && (FlyByWire_U.in.data.V_tas_kn > 100.0) &&
    ...
    if ((FlyByWire_DWork.Delay_DSTATE_e == 1.0) || (FlyByWire_U.in.data.H_radio_ft > 400.0) ||
  ...
  rtb_Limiterxi1 = rtb_Limiterxi + FlyByWire_P.Constant_Value_n;
  FlyByWire_DWork.Delay1_DSTATE = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_n - rtb_Limiterxi) *
  ...
  rtb_Limiterxi1 = rtb_ManualSwitch - FlyByWire_DWork.Delay_DSTATE_er;
  ...
  FlyByWire_DWork.Delay_DSTATE_er += rtb_Limiterxi1;
  ...
  rtb_Limiterxi1 = FlyByWire_B.flare_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_ib;
  ...
  FlyByWire_DWork.Delay_DSTATE_ib += rtb_Limiterxi1;
  ...
  rtb_Limiterxi1 = FlyByWire_U.in.data.autopilot_custom_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_n;
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold_k) {
    rtb_Sum5 = (FlyByWire_DWork.Delay_DSTATE_n - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    rtb_Gain1_h = FlyByWire_P.Gain1_Gain * rtb_GainTheta;
    if (rtb_in_flare > FlyByWire_P.Switch_Threshold) {
      rtb_Switch_c = (FlyByWire_DWork.Delay_DSTATE_ib - rtb_GainTheta) * FlyByWire_P.Gain_Gain;
    ...
    if (FlyByWire_DWork.Delay_DSTATE_p <= rtb_Saturation2) {
      ...
      if (FlyByWire_DWork.Delay_DSTATE_p >= rtb_Saturation2) {
        rtb_Saturation2 = FlyByWire_DWork.Delay_DSTATE_p;
      }
    }
  ...
  rtb_Sum5 += std::cos(FlyByWire_P.Gain1_Gain_p * rtb_GainTheta) / std::cos(FlyByWire_P.Gain1_Gain_b * rtb_Gain1_h);
  ...
  rtb_Gain1_h = rtb_Limiterxi * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.DLUT_bp01Data,
    FlyByWire_P.DLUT_tableData, 1U) * FlyByWire_P.DiscreteDerivativeVariableTs_Gain;
  rtb_Limiterxi = (rtb_Gain1_h - FlyByWire_DWork.Delay_DSTATE_f) / FlyByWire_U.in.time.dt + rtb_Limiterxi *
  ...
  rtb_Limiterxi1 = Theta - FlyByWire_DWork.Delay_DSTATE_m;
  ...
  rtb_Limitereta = look1_binlxpw(FlyByWire_DWork.Delay_DSTATE_m, FlyByWire_P.PitchRateDemand_bp01Data,
    FlyByWire_P.PitchRateDemand_tableData, 2U);
  rtb_Switch_c = FlyByWire_P.Gain5_Gain * result_0[1] + result[1];
  rtb_Sum5 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_d;
  rtb_Limiterxi = rtb_Sum5 + FlyByWire_P.Constant_Value_c;
  FlyByWire_DWork.Delay1_DSTATE_e = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_c - rtb_Sum5) *
    FlyByWire_DWork.Delay1_DSTATE_e + (rtb_Switch_c + FlyByWire_DWork.Delay_DSTATE_g) * (rtb_Sum5 / rtb_Limiterxi);
  rtb_Saturation2 = FlyByWire_P.DiscreteDerivativeVariableTs_Gain_m * rtb_Limitereta;
  rtb_Sum5 = result[1] - rtb_Limitereta;
  rtb_Gain_i = FlyByWire_P.Gain1_Gain_pn * rtb_Sum5 * FlyByWire_P.DiscreteDerivativeVariableTs_Gain_a;
  rtb_Limiterxi1 = (rtb_Gain_i - FlyByWire_DWork.Delay_DSTATE_ec) / FlyByWire_U.in.time.dt + FlyByWire_P.Gain_Gain_do *
    rtb_Sum5;
  ...
  rtb_Sum5 = ((((rtb_Saturation2 - FlyByWire_DWork.Delay_DSTATE_o) / FlyByWire_U.in.time.dt * FlyByWire_P.Gain3_Gain_h +
                FlyByWire_P.Gain1_Gain_c * rtb_Limiterxi1) + (FlyByWire_DWork.Delay1_DSTATE_e - rtb_Limitereta) *
  ...
  if ((FlyByWire_DWork.Delay_DSTATE_er == 0.0) || (rtb_BusAssignment_a_sim_data_computed_tracking_mode_on != 0)) {
  ...
  if (FlyByWire_DWork.Delay_DSTATE_e > FlyByWire_P.Saturation_UpperSat_g) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_g;
  } else if (FlyByWire_DWork.Delay_DSTATE_e < FlyByWire_P.Saturation_LowerSat_j) {
  ...
  rtb_Sum1_b = FlyByWire_P.Constant_Value_i - rtb_Limitereta;
  if (FlyByWire_DWork.Delay_DSTATE_er > FlyByWire_P.Saturation_UpperSat_b) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_b;
  } else if (FlyByWire_DWork.Delay_DSTATE_er < FlyByWire_P.Saturation_LowerSat_ee) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_ee;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_er;
  }

  rtb_Limiterxi = FlyByWire_DWork.Delay_DSTATE_gf * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_ns - rtb_Limitereta;
  rtb_Limitereta *= rtb_BusAssignment_c_pitch_data_computed_delta_eta_deg;
  rtb_BusAssignment_m_pitch_output_eta_deg = (rtb_Limiterxi + rtb_Limitereta) * rtb_Sum1_b + rtb_Sum5;
  ...
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_mx - FlyByWire_DWork.Delay_DSTATE_d;
  ...
  rtb_Limiterxi1 = rtb_Limitereta - FlyByWire_DWork.Delay_DSTATE_dd;
  ...
  FlyByWire_DWork.Delay_DSTATE_dd += rtb_Limiterxi1;
  rtb_Sum1_b = FlyByWire_U.in.data.engine_1_thrust_lbf - FlyByWire_U.in.data.engine_2_thrust_lbf;
  rtb_Limiterxi = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_l;
  rtb_Limiterxi1 = rtb_Limiterxi + FlyByWire_P.Constant_Value_o;
  FlyByWire_DWork.Delay1_DSTATE_k = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_o - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_k + (rtb_Sum1_b + FlyByWire_DWork.Delay_DSTATE_d1) * (rtb_Limiterxi / rtb_Limiterxi1);
  rtb_Product_g = FlyByWire_DWork.Delay1_DSTATE_k * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
  ...
  rtb_Limitereta = rtb_Limiterxi1 * FlyByWire_DWork.Delay_DSTATE_dd;
  rtb_Sum5 = FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_d * rtb_Limitereta * FlyByWire_U.in.time.dt;
  if ((FlyByWire_DWork.Delay_DSTATE_dd == 0.0) || (rtb_BusAssignment_a_sim_data_computed_tracking_mode_on != 0) ||
  ...
  rtb_Sum5 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_j;
  ...
  rtb_Limiterxi1 = rtb_Gain1_l - FlyByWire_DWork.Delay_DSTATE_iw;
  ...
  FlyByWire_DWork.Delay_DSTATE_iw += rtb_Limiterxi1;
  rtb_Limiterxi1 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_du;
  rtb_Sum5 = rtb_Limiterxi1 + FlyByWire_P.Constant_Value_f;
  FlyByWire_DWork.Delay1_DSTATE_a = 1.0 / rtb_Sum5 * (FlyByWire_P.Constant_Value_f - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_a + (rtb_Gain + FlyByWire_DWork.Delay_DSTATE_ij) * (rtb_Limiterxi1 / rtb_Sum5);
  rtb_Sum5 = FlyByWire_U.in.time.dt * FlyByWire_P.WashoutFilter_C1;
  rtb_Limiterxi = rtb_Sum5 + FlyByWire_P.Constant_Value_d;
  rtb_Product3 = FlyByWire_P.Constant_Value_d / rtb_Limiterxi;
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_oo * rtb_Product3;
  rtb_Product3 *= rtb_Gain;
  FlyByWire_DWork.Delay1_DSTATE_p = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_d - rtb_Sum5) *
    FlyByWire_DWork.Delay1_DSTATE_p + (rtb_Product3 - rtb_Limiterxi1);
  FlyByWire_Y.out.roll.law_normal.pk_c_deg_s = rtb_Limitereta;
  rtb_BusAssignment_e_roll_law_normal_xi_deg = ((FlyByWire_P.Gain3_Gain_k * FlyByWire_DWork.Delay_DSTATE_iw +
  ...
  rtb_Limiterxi1 = static_cast<real_T>(rtb_on_ground) - FlyByWire_DWork.Delay_DSTATE_ds;
  ...
  FlyByWire_DWork.Delay_DSTATE_ds += rtb_Limiterxi1;
  if (FlyByWire_DWork.Delay_DSTATE_ds > FlyByWire_P.Saturation_UpperSat_i) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_i;
  } else if (FlyByWire_DWork.Delay_DSTATE_ds < FlyByWire_P.Saturation_LowerSat_m) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_m;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_ds;
  }

  rtb_Sum5 = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg * rtb_Limitereta;
  rtb_Sum1_i = FlyByWire_P.Constant_Value_ct - rtb_Limitereta;
  rtb_Limiterxi = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_c;
  rtb_Limiterxi1 = rtb_Limiterxi + FlyByWire_P.Constant_Value_m5;
  FlyByWire_DWork.Delay1_DSTATE_eb = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_m5 - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_eb + (FlyByWire_U.in.data.beta_deg + FlyByWire_DWork.Delay_DSTATE_an) * (rtb_Limiterxi
    / rtb_Limiterxi1);
  rtb_Product3 = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg + rtb_Product_g;
  rtb_Limitereta = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter1_C1;
  rtb_Limiterxi = rtb_Limitereta + FlyByWire_P.Constant_Value_f3;
  FlyByWire_DWork.Delay1_DSTATE_m = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_f3 - rtb_Limitereta) *
    FlyByWire_DWork.Delay1_DSTATE_m + (rtb_Product3 + FlyByWire_DWork.Delay_DSTATE_k) * (rtb_Limitereta / rtb_Limiterxi);
  rtb_AND = ((rtb_BusAssignment_a_sim_data_computed_tracking_mode_on == 0) && (FlyByWire_U.in.data.autopilot_custom_on
              != 0.0));
  if (rtb_AND) {
    rtb_Limitereta = FlyByWire_DWork.Delay1_DSTATE_m;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay1_DSTATE_eb;
  }
  ...
  rtb_Limiterxi1 = (rtb_Limiterxi + FlyByWire_DWork.Delay_DSTATE_gt) - FlyByWire_DWork.Delay_DSTATE_a;
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Saturation_UpperSat_eb) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_eb;
  } else if (FlyByWire_U.in.data.autopilot_custom_on < FlyByWire_P.Saturation_LowerSat_b) {
  ...
  rtb_Limiterxi1 = (FlyByWire_DWork.Delay1_DSTATE_a - std::sin(FlyByWire_P.Gain1_Gain_br *
    FlyByWire_DWork.Delay_DSTATE_j) * FlyByWire_P.Constant2_Value_l * std::cos(FlyByWire_P.Gain1_Gain_cq * rtb_GainTheta)
                    / (FlyByWire_P.Gain6_Gain_j * rtb_Limiterxi) * FlyByWire_P.Gain_Gain_cd) * FlyByWire_P.Gain_Gain_h;
  rtb_Limiterxi = FlyByWire_P.Gain6_Gain_k * FlyByWire_DWork.Delay1_DSTATE_p;
  ...
  rtb_Limitereta = ((rtb_Sum1_i * FlyByWire_DWork.Delay_DSTATE_a + rtb_Sum5) * rtb_Limitereta +
                    (FlyByWire_P.Constant_Value_fn - rtb_Limitereta) * FlyByWire_P.Constant3_Value) +
    ((FlyByWire_DWork.Delay_DSTATE_iw + rtb_Limiterxi1) * FlyByWire_DWork.Delay_DSTATE_dd + rtb_Limiterxi);
  ...
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_fz - FlyByWire_DWork.Delay_DSTATE_j4;
  ...
  FlyByWire_DWork.Delay_DSTATE_j4 += rtb_Limiterxi1;
  rtb_Sum1_i = rtb_Limitereta;
  rtb_Limiterxi = FlyByWire_DWork.Delay_DSTATE_dd + FlyByWire_U.in.data.autopilot_custom_on;
  ...
  if (rtb_Limitereta > FlyByWire_P.Saturation_UpperSat_h) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_h;
  } else {
    if (rtb_Limitereta < FlyByWire_P.Saturation_LowerSat_bu) {
      rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_bu;
    }
  }

  rtb_Sum5 = rtb_BusAssignment_e_roll_law_normal_xi_deg * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_c1 - rtb_Limitereta;
  ...
  if (rtb_Limiterxi > FlyByWire_P.Saturation_UpperSat_es) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_es;
  } else if (rtb_Limiterxi < FlyByWire_P.Saturation_LowerSat_nh) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_nh;
  } else {
    rtb_Limitereta = rtb_Limiterxi;
  }

  rtb_Limiterxi = rtb_Sum1_i * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_h - rtb_Limitereta;
  rtb_Limitereta *= rtb_Gain1_l;
  rtb_Limiterxi += rtb_Limitereta;
  rtb_Limiterxi1 = rtb_BusAssignment_m_pitch_output_eta_deg - FlyByWire_DWork.Delay_DSTATE_dr;
  ...
  FlyByWire_DWork.Delay_DSTATE_dr += rtb_Limiterxi1;
  rtb_Limiterxi1 = rtb_Sum5 - FlyByWire_DWork.Delay_DSTATE_ow;
  ...
  FlyByWire_DWork.Delay_DSTATE_ow += rtb_Limiterxi1;
  rtb_Limiterxi1 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_kw;
  ...
  FlyByWire_DWork.Delay_DSTATE_kw += rtb_Limiterxi1;
  ...
  FlyByWire_Y.out.pitch.data_computed.in_rotation_gain = FlyByWire_DWork.Delay_DSTATE_er;
  ...
  FlyByWire_Y.out.pitch.data_computed.flare_Theta_c_deg = FlyByWire_DWork.Delay_DSTATE_ib;
  ...
  FlyByWire_Y.out.pitch.output.eta_trim_deg = FlyByWire_DWork.Delay_DSTATE_d;
  ...
  FlyByWire_Y.out.roll.data_computed.in_flight_gain = FlyByWire_DWork.Delay_DSTATE_dd;
  FlyByWire_Y.out.roll.data_computed.zeta_trim_deg_should_write = (FlyByWire_U.in.data.autopilot_custom_on != 0.0);
  FlyByWire_Y.out.roll.data_computed.beta_target_deg = rtb_Product_g;
  ...
  FlyByWire_Y.out.roll.law_normal.zeta_deg = rtb_Sum1_i;
  FlyByWire_Y.out.roll.output.xi_deg = rtb_Sum5;
  FlyByWire_Y.out.roll.output.zeta_deg = rtb_Limiterxi;
  FlyByWire_Y.out.roll.output.zeta_trim_deg = FlyByWire_DWork.Delay_DSTATE_j4;
  rtb_Limiterxi1 = FlyByWire_P.Gaineta_Gain_d * FlyByWire_DWork.Delay_DSTATE_dr;
  ...
  rtb_Limiterxi1 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_d;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi_Gain_n * FlyByWire_DWork.Delay_DSTATE_ow;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi1_Gain_e * FlyByWire_DWork.Delay_DSTATE_kw;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi2_Gain * FlyByWire_DWork.Delay_DSTATE_j4;
  ...
  FlyByWire_DWork.Delay_DSTATE_f = rtb_Gain1_h;
  FlyByWire_DWork.icLoad = 0U;
  FlyByWire_DWork.Delay_DSTATE_g = rtb_Switch_c;
  FlyByWire_DWork.Delay_DSTATE_o = rtb_Saturation2;
  FlyByWire_DWork.Delay_DSTATE_ec = rtb_Gain_i;
  FlyByWire_DWork.icLoad_m = 0U;
  FlyByWire_DWork.icLoad_b = 0U;
  FlyByWire_DWork.Delay_DSTATE_d1 = rtb_Sum1_b;
  FlyByWire_DWork.icLoad_ms = 0U;
  FlyByWire_DWork.Delay_DSTATE_ij = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_oo = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_an = FlyByWire_U.in.data.beta_deg;
  FlyByWire_DWork.Delay_DSTATE_k = rtb_Product3;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_i = FlyByWire_P.Delay_InitialCondition_o;
  FlyByWire_DWork.Delay1_DSTATE = FlyByWire_P.Delay1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_er = FlyByWire_P.RateLimiterVariableTs1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_ib = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_n = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_h;
  ...
  FlyByWire_DWork.icLoad = 1U;
  FlyByWire_DWork.Delay_DSTATE_m = FlyByWire_P.RateLimiterVariableTs_InitialCondition_k;
  FlyByWire_DWork.Delay_DSTATE_g = FlyByWire_P.Delay_InitialCondition_h;
  FlyByWire_DWork.Delay1_DSTATE_e = FlyByWire_P.Delay1_InitialCondition_g;
  FlyByWire_DWork.Delay_DSTATE_o = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_k;
  FlyByWire_DWork.Delay_DSTATE_ec = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition_p;
  FlyByWire_DWork.icLoad_m = 1U;
  FlyByWire_DWork.icLoad_b = 1U;
  FlyByWire_DWork.Delay_DSTATE_d = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
  FlyByWire_DWork.Delay_DSTATE_dd = FlyByWire_P.RateLimiterVariableTs_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_d1 = FlyByWire_P.Delay_InitialCondition_k;
  FlyByWire_DWork.Delay1_DSTATE_k = FlyByWire_P.Delay1_InitialCondition_n;
  FlyByWire_DWork.Delay_DSTATE_j = FlyByWire_P.RateLimiterVariableTs2_InitialCondition;
  FlyByWire_DWork.icLoad_ms = 1U;
  FlyByWire_DWork.Delay_DSTATE_iw = FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc;
  FlyByWire_DWork.Delay_DSTATE_ij = FlyByWire_P.Delay_InitialCondition_e;
  FlyByWire_DWork.Delay1_DSTATE_a = FlyByWire_P.Delay1_InitialCondition_e;
  FlyByWire_DWork.Delay_DSTATE_oo = FlyByWire_P.Delay_InitialCondition_f;
  FlyByWire_DWork.Delay1_DSTATE_p = FlyByWire_P.Delay1_InitialCondition_m;
  FlyByWire_DWork.Delay_DSTATE_ds = FlyByWire_P.RateLimiterVariableTs_InitialCondition_p;
  FlyByWire_DWork.Delay_DSTATE_a = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_an = FlyByWire_P.Delay_InitialCondition_o5;
  FlyByWire_DWork.Delay1_DSTATE_eb = FlyByWire_P.Delay1_InitialCondition_e1;
  FlyByWire_DWork.Delay_DSTATE_k = FlyByWire_P.Delay_InitialCondition_g;
  FlyByWire_DWork.Delay1_DSTATE_m = FlyByWire_P.Delay1_InitialCondition_f;
  FlyByWire_DWork.icLoad_i = 1U;
  FlyByWire_DWork.Delay_DSTATE_j4 = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i4;
  FlyByWire_DWork.icLoad_c = 1U;
  FlyByWire_DWork.Delay_DSTATE_dr = FlyByWire_P.RateLimitereta_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_ow = FlyByWire_P.RateLimiterxi_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_kw = FlyByWire_P.RateLimiterzeta_InitialCondition;
